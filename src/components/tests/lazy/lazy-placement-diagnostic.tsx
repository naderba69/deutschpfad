...
export const LazyPlacementDiagnostic = dynamic(
  () => import("@/components/tests/placement-diagnostic").then((m) => m.PlacementDiagnostic),
  { loading: TestLoading, ssr: false },
);

export const LazyQuickPlacement = dynamic(
  () => import("@/components/placement/placement-test").then((m) => m.PlacementTest),
  { loading: TestLoading, ssr: false },
);
