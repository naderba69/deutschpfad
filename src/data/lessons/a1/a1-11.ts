...
export const lessonA111: Lesson = {
  ...
  lernziele: [
    {
      id: "z1",
      de: "Ich kann Orte in der Stadt nennen.",
      ar: "أن أسمّي الأماكن: المحطة، السوق، الصيدلية، البنك...",
    },
    {
      id: "z2",
      de: "Ich kann nach dem Weg fragen.",
      ar: "أن أسأل عن الطريق: Entschuldigung, wo ist der Bahnhof?",
    },
    {
      id: "z3",
      de: "Ich kann Richtungen verstehen: geradeaus, rechts, links.",
      ar: "أن أفهم الاتجاهات: مباشرة، يمين، يسار.",
    },
    {
      id: "z4",
      de: "Ich kann sagen: Ich gehe zum Supermarkt, in die Stadt.",
      ar: "أن أعبر عن الحركة: أذهب إلى السوق (zu) أو إلى المدينة (in).",
    },
  ],
  einfuehrung: {
    ...
    connectionToPreviousAr:
      "في درس السكن تعلمنا wo? مع Dativ. اليوم نضيف wohin? مع Akkusativ — القاعدة «السكون/الحركة» تكتمل.",
    activateVocabulary: [
  ...
  theory: [
    {
      ...
      examples: [
        ...
        },
        {
          ...
          ar: "عذراً، كيف أصل إلى المحطة؟ (أفضل من wo ist)",
        },
        {
          de: "Der Bahnhof ist in der Stadtmitte.",
          ar: "المحطة في وسط المدينة.",
        },
        {
        ...
        {
          de: "Die Haltestelle ist gegenüber vom Kino.",
          ar: "الموقف مقابل السينما.",
        },
        {
      ...
      commonMistakes: [
        {
          wrong: "Wo ist das Apotheke?",
          right: "Wo ist die Apotheke?",
          whyAr:
            "die Apotheke مؤنّثة، وكلّ الكلمات المنتهية بـ ـe في الألمانية مؤنّثة في الغالب الأعمّ (die Schule, die Kirche, die Straße). وهذه علامة صرفية تنفعك في تخمين جنس المئات.",
        },
        {
          wrong: "Entschuldigung, Bahnhof?",
          right: "Entschuldigung, wo ist der Bahnhof?",
          whyAr:
            "إسقاط الأداة والفعل يجعل الجملة برقيةً لا سؤالاً. والألمانية لا تقبل جملةً بلا فعل مصرَّف، ولا اسماً بلا أداة في هذا الموضع.",
        },
        {
          wrong: "Wie komme ich zu der Bahnhof?",
          right: "Wie komme ich zum Bahnhof?",
          whyAr:
            "خطآن: der Bahnhof مذكّر فيصير في الجرّ dem، وzu + dem تندمجان وجوباً في zum. والصيغة المفكوكة zu dem لا تُستعمل في الكلام العاديّ.",
        },
        {
          wrong: "Das Krankenhaus ist der neben Park.",
          right: "Das Krankenhaus ist neben dem Park.",
          whyAr:
            "حرف الجرّ يسبق الأداة لا يتأخّر عنها، وneben يطلب الجرّ عند وصف موقع ثابت فتصير der ⇐ dem. وترتيب «الأداة ثمّ الحرف» انعكاسٌ لترتيب العربية «بجانب الحديقة».",
        },
      ],
      relatedRuleComparison: {
        title: "أسماء الأماكن والأدوات",
        content:
          "المستشفى = das Krankenhaus (من krank مريض + Haus بيت) — الكلمات المركبة تأخذ جنس المكوّن الأخير: Haus محايد.",
      },
    },
    {
      id: "t2",
      ...
      table: {
        ...
        rows: [
          {
            label: "nach",
            cells: ["بلدان/مدن/منزل", "nach Deutschland, nach Tunis"],
          },
          {
            label: "zu (+dem/der)",
            cells: ["أماكن/أشخاص", "zum Bahnhof, zur Apotheke, zu Hause"],
          },
          {
            label: "in (+den/das/die)",
            cells: ["أماكن مغلقة (دخول)", "in die Stadt, ins Kino"],
          },
        ],
      },
      examples: [
        {
          ...
          ar: "اذهب مباشرةً ثمّ يميناً!",
        },
        {
          de: "Ich fahre nach Deutschland.",
          ar: "أسافر إلى ألمانيا. (بلد ⇐ nach بلا أداة)",
        },
        {
          de: "Wir gehen zum Bahnhof.",
          ar: "نذهب إلى المحطة. (zu + dem = zum)",
        },
        ...
        { de: "Ich gehe in die Stadt.", ar: "أذهب إلى المدينة. (حركة ⇐ نصب)" },
        {
          ...
          ar: "هذا المساء نذهب إلى السينما. (دخول ⇐ ins)",
        },
        {
          de: "An der Ampel gehen Sie links.",
          ar: "عند الإشارة اتّجه يساراً.",
        },
        {
          de: "Ich fahre jetzt nach Hause.",
          ar: "أذهب الآن إلى البيت. (تعبير جامد)",
        },
      ],
      comparisonWithArabic:
      ...
      commonMistakes: [
        {
          wrong: "Ich fahre nach dem Bahnhof.",
          right: "Ich fahre zum Bahnhof.",
          whyAr:
            "nach لا تُستعمل إلّا مع البلدان والمدن وكلمة Hause، وعلامتها أنّها تأتي بلا أداة. والأماكن ذات الأداة تأخذ zu: zum Bahnhof.",
        },
        {
          wrong: "Ich gehe in der Stadt. (بمعنى: سأذهب إلى المدينة)",
          right: "Ich gehe in die Stadt.",
          whyAr:
            "الفعل gehen يدلّ على انتقال، والانتقال يطلب النصب: in die Stadt. أمّا in der Stadt فتصف مكاناً ثابتاً، فتصير الجملة «أمشي داخل المدينة» لا «أذهب إليها».",
        },
        {
          wrong: "Wir gehen in das Kino.",
          right: "Wir gehen ins Kino.",
          whyAr:
            "in + das تندمجان وجوباً في ins في الاستعمال العاديّ. والصيغة المفكوكة لا تُقال إلّا للتوكيد على سينما بعينها، وهي نادرة.",
        },
        {
          wrong: "Ich bin nach Hause.",
          right: "Ich bin zu Hause.",
          whyAr:
            "تعبيران جامدان لا يُقاسان: nach Hause للحركة (ذاهب إلى البيت) وzu Hause للثبات (موجود في البيت). وخلطهما من أشيع أخطاء المستوى الأوّل.",
        },
      ],
      relatedRuleComparison: {
        title: "wo? / wohin? / woher?",
        content:
          "wo? (أين؟ سكون) → Dativ: in der Stadt. wohin? (إلى أين؟ حركة) → Akkusativ: in die Stadt. woher? (من أين؟) → aus: aus Deutschland. ثلاثية كاملة للمكان!",
      },
    },
    {
      id: "t3",
      ...
      table: {
        ...
        rows: [
          {
            label: "der Bus",
            cells: ["mit dem Bus", "Ich fahre mit dem Bus."],
          },
          {
            label: "die Bahn / die U-Bahn",
            cells: ["mit der Bahn", "Sie fährt mit der U-Bahn."],
          },
          {
            label: "das Fahrrad",
            cells: ["mit dem Fahrrad", "Wir fahren mit dem Fahrrad."],
          },
          {
            label: "das Flugzeug",
            cells: ["mit dem Flugzeug", "Er fliegt nach Berlin."],
          },
          {
            label: "بلا وسيلة",
            cells: ["zu Fuß (استثناء)", "Ich gehe zu Fuß."],
          },
        ],
      },
      examples: [
        {
          ...
          ar: "أذهب كلّ يوم بالحافلة إلى العمل.",
        },
        {
        ...
        {
          de: "Sie fliegt mit dem Flugzeug nach Tunis.",
          ar: "تسافر بالطائرة إلى تونس. (طيران ⇐ fliegen)",
        },
        {
          de: "Ich steige in Köln um.",
          ar: "أبدّل القطار في كولونيا. (فعل منفصل)",
        },
        {
          de: "Wo ist die Haltestelle? — Dort, gegenüber der Post.",
          ar: "أين الموقف؟ — هناك، مقابل البريد.",
        },
        {
          de: "Eine Fahrkarte nach Berlin, bitte.",
          ar: "تذكرة إلى برلين من فضلك.",
        },
      ],
      comparisonWithArabic:
      ...
      commonMistakes: [
        {
          ...
          whyAr:
            "der Bus في الجرّ يصير dem لا den. والنون هنا خطأ شائع لأنّ المتعلّم يخلط النصب بالجرّ، وmit لا تعرف النصب إطلاقاً.",
        },
        {
          wrong: "Ich gehe mit Fuß.",
          right: "Ich gehe zu Fuß.",
          whyAr:
            "تعبير جامد يُحفظ كما هو: zu Fuß. والقدمان لا تُعدّان وسيلة نقل فلا تأخذان mit، ولا يُقال mit den Füßen أيضاً.",
        },
        {
          wrong: "Ich gehe nach Berlin.",
          right: "Ich fahre nach Berlin.",
          whyAr:
            "gehen تعني المشي على القدمين لا الذهاب مطلقاً، فالجملة تقول إنّك ستمشي إلى برلين. والعربية والإنجليزية تملكان فعلاً عامّاً واحداً، والألمانية توزّعه على fahren وfliegen وgehen.",
        },
        {
          wrong:
            "Ich fahre mit dem Flugzeug nach Tunis. — Nein: Ich gehe mit dem Flugzeug.",
          right: "Ich fliege nach Tunis.",
          whyAr:
            "الطيران له فعله الخاصّ fliegen، ويُغني عن ذكر الوسيلة أصلاً. فقولك mit dem Flugzeug fliegen تكرارٌ مقبول لكنّه ثقيل، وgehen معه خطأ صريح.",
        },
      ],
      relatedRuleComparison: {
      ...
      examples: [
        {
          ...
          ar: "أين المحطة؟ — أراها هناك. (der ⇐ ihn)",
        },
        {
          de: "Kennst du die Apotheke? — Ja, ich kenne sie.",
          ar: "أتعرف الصيدلية؟ — نعم، أعرفها.",
        },
        {
          de: "Das Kino ist neu. Ich finde es sehr schön.",
          ar: "السينما جديدة. أجدها جميلة جداً. (das ⇐ es)",
        },
        {
          de: "Nimmst du den Bus? — Ja, ich nehme ihn.",
          ar: "أتأخذ الحافلة؟ — نعم، آخذها.",
        },
        {
          de: "Entschuldigung, können Sie mich hören?",
          ar: "عذراً، هل تسمعني؟",
        },
        { de: "Ich brauche dich heute Abend.", ar: "أحتاجك هذا المساء." },
        {
          de: "Der Weg ist lang. Wir kennen ihn nicht.",
          ar: "الطريق طويل. لا نعرفه.",
        },
        {
          de: "Dort sehe ich ihn.",
          ar: "هناك أراه. (الضمير مباشرةً بعد الفعل)",
        },
      ],
      comparisonWithArabic:
      ...
      commonMistakes: [
        {
          ...
          right: "Ich sehe ihn.",
          whyAr:
            "المتعلّم اختار es لأنّ المحطة في ذهنه «شيء» جامد. والألمانية لا تنظر إلى الشيء بل إلى الأداة: der Bahnhof مذكّر ⇐ ihn. والسؤال الصحيح دائماً: ما أداة هذه الكلمة؟",
        },
        {
          wrong: "Ich kenne er nicht.",
          right: "Ich kenne ihn nicht.",
          whyAr:
            "er ضمير فاعل لا مفعول. وkennen فعل متعدٍّ ينصب مفعوله، فيلزم ihn. والعربي يقع فيه لأنّه يترجم «هو» لا «إيّاه»، والعربية لا تُبدّل الضمير تبديلاً كاملاً.",
        },
        {
          wrong: "Siehst du mich? — Ja, ich sehe du.",
          right: "Ja, ich sehe dich.",
          whyAr:
            "du للفاعل وdich للمفعول. والخطأ يكشف أنّ المتعلّم يحفظ الضمائر قائمةً واحدة لا جدولاً بحالتين. وكلّ ضمير له صورتان على الأقلّ.",
        },
        {
          wrong: "Ich sehe die Kirche. Ich gehe an die vorbei.",
          right: "Ich gehe an ihr vorbei.",
          whyAr:
            "حرف الجرّ an يفرض حالته على الضمير، وvorbeigehen an يطلب الجرّ (Dativ) فتصير sie ⇐ ihr. فالضمير لا يتبع الفعل وحده بل حرف الجرّ إن وُجد.",
        },
      ],
      relatedRuleComparison: {
  ...
  reading: {
    ...
    questions: [
      {
        ...
        options: ["Mit der U-Bahn", "Mit dem Bus", "Mit dem Auto", "Zu Fuß"],
        correctIndex: 0,
        paragraph: 0,
        explanation:
          "Sie fährt zuerst mit der U-Bahn bis zum Hauptbahnhof — وmit + Dativ: der U-Bahn.",
      },
      {
        id: "rq2",
        type: "multiple-choice",
        ...
        paragraph: 2,
        explanation:
          "An der Ampel gehen Sie links — ثمّ أوّل شارع يميناً بعد الكنيسة.",
      },
      {
        id: "rq3",
        type: "multiple-choice",
        ...
        paragraph: 3,
        explanation:
          "Das Institut ist gegenüber von einer Apotheke — والمرأة تؤكّد: Sie können es nicht verpassen.",
      },
      {
        id: "rq4",
        type: "multiple-choice",
        ...
        paragraph: 4,
        explanation:
          "Der Bus kommt erst in einer Viertelstunde — فالمشي أسرع اليوم رغم أنّه يستغرق عشر دقائق.",
      },
      {
        id: "rq5",
        type: "multiple-choice",
        ...
        paragraph: 5,
        explanation:
          "تجيب المرأة: Nichts zu danken. Viel Erfolg im Kurs! — وهي صيغة معيارية للردّ على الشكر.",
      },
    ],
    redemittel: [
      {
    ...
    discussionAr:
      "صف الطريق من بيتك إلى أقرب محطّة أو سوق: بأيّ وسيلة تذهب (mit + Dativ؟ أم zu Fuß؟)، وكم يستغرق، وما المعالم التي تمرّ بها؟ واستعمل geradeaus وlinks/rechts وضميراً واحداً من ضمائر النصب.",
  },
    ...
    items: [
      {
        ...
        lines: [
          ...
          },
          {
            ...
            ar: "اذهبوا مباشرة ثم يساراً. المحطة بجانب الحديقة.",
          },
      ...
      },
      {
        ...
        lines: [
          ...
          },
          {
            ...
            ar: "وأنا أسافر/أذهب إلى المنزل.",
          },
          {
            speaker: "Karim",
            de: "Bis später! Wir sehen uns im Kino um acht.",
            ar: "إلى اللقاء! نراك في السينما في الثامنة.",
          },
        ],
      },
    ],
    questions: [
      {
        ...
        correctIndex: 0,
        explanation:
          "قال المارة: Der Bahnhof ist neben dem Park — بجانب الحديقة.",
        errorType: "preposition",
      },
      {
        id: "q2",
  ...
  pronunciation: {
    ...
    items: [
      ...
      { de: "die Apotheke", ar: "الصيدلية", note: "th = ت فقط: آبوتيكِه" },
      {
        de: "das Krankenhaus",
        ar: "المستشفى",
        note: "لا يوجد ch هنا: nk = نغ+ك، وh مسموعة لأنها تبدأ الجزء الثاني (Kranken+Haus): كرانكن-هاوس",
      },
    ...
    shadowing: [
      {
        de: "Entschuldigung, wo ist die Apotheke?",
        ar: "عذراً، أين الصيدلية؟",
        tip: "Entschuldigung = إنت-شول-دي-غونغ (sch = ش)",
      },
      {
        de: "Gehen Sie geradeaus!",
        ar: "اذهبوا مباشرة!",
        tip: "geradeaus = غرادِه-آوس",
      },
      {
        de: "Ich gehe in die Stadt.",
        ar: "أذهب إلى المدينة.",
        tip: "Stadt = شتات (st في البداية)",
      },
      {
  ...
  writing: [
    {
      ...
      explanation:
        "اختر الحرف حسب الوجهة: in (مغلق)، zum (مكان)، nach (بلد/مدينة).",
      errorType: "preposition",
    },
    {
      id: "w2",
      ...
      template:
        "Ich fahre ___ Deutschland. Wir gehen ___ Bahnhof. Sie geht ___ Apotheke. Er geht ___ Kino.",
      blanks: [
      ...
      explanation:
        "nach + بلد، zum (zu+dem) + مكان مذكر، zur (zu+der) + مكان مؤنث، ins (in+das) + مكان محايد.",
      errorType: "preposition",
    },
    {
      id: "w3",
      ...
      explanation:
        "الصيدلية خلف الزاوية — um die Ecke من أشهر عبارات الاتجاهات.",
      errorType: "spelling",
    },
  ],
  practiceBank: [
    ...
    },
    {
      ...
      explanation:
        "مباشرة (geradeaus)، ثم يسار (links)، عند الزاوية (um die Ecke).",
      errorType: "vocabulary",
    },
    {
      id: "e7",
    ...
    },
    {
      ...
      explanation:
        "الحركة إلى المنزل: nach Hause. (zu Hause = في المنزل، سكون).",
      errorType: "preposition",
    },
    {
      id: "e10",
      ...
      explanation:
        "السوبرماركت بجانب المحطة — neben + Dativ: neben dem Bahnhof.",
      errorType: "spelling",
    },
    {
      id: "e11",
      ...
      template:
        "Ich fahre mit ___ Bus. Sie fährt mit ___ U-Bahn. Wir fahren mit ___ Auto.",
      blanks: [
      ...
      explanation:
        "mit يطلب الجرّ دائماً: der Bus ⇒ dem · die U-Bahn ⇒ der · das Auto ⇒ dem.",
      errorType: "case",
    },
    {
      id: "e12",
      ...
      explanation:
        "«مشياً» تعبير جامد لا يُترجم حرفياً: zu Fuß، بلا mit وبلا أداة.",
      errorType: "preposition",
    },
    {
      id: "e13",
    ...
    },
    {
      ...
      explanation:
        "الفاعل ثم الفعل ثم الوسيلة (mit + Dativ) ثم الوجهة (zur Uni).",
      errorType: "word-order",
    },
    {
      id: "e15",
    ...
    },
    {
      id: "e16",
      type: "multiple-choice",
      instructionAr: "اختر ضمير المفعول به الصحيح:",
      questionDe: "Wo ist der Bahnhof? — Ich sehe ___ dort.",
      options: ["ihn", "es", "sie", "er"],
      correctIndex: 0,
      errorType: "pronoun",
      explanation:
        "der Bahnhof مذكّر، وضمير المذكّر في النصب ihn. والأداة تُملي الضمير لا طبيعة الشيء.",
    },
    {
      id: "e17",
      type: "multiple-choice",
      ...
      options: ["sie", "ihn", "es", "ihr"],
      correctIndex: 0,
      errorType: "pronoun",
      explanation:
        "die Apotheke مؤنّثة، والمؤنّث لا يتغيّر بين الرفع والنصب: sie تبقى sie.",
    },
    {
      id: "e18",
      type: "error-correction",
      instructionAr: "صحّح الضمير:",
      ...
      errorType: "pronoun",
      explanation:
        "er ضمير فاعل، وkennen ينصب مفعوله فيلزم ihn. والعربي يترجم «هو» لا «إيّاه» فيبقي على صيغة الرفع.",
    },
    {
      id: "e19",
      type: "fill-blank",
      instructionAr: "أكمل بأداة الحركة أو الثبات الصحيحة:",
      errorType: "case",
      template: "Ich bin ___ Stadt. Morgen gehe ich ___ Stadt.",
      blanks: [
        {
          correct: "in der",
          options: ["in der", "in die", "in den", "in dem"],
          errorType: "case",
        },
        {
          correct: "in die",
          options: ["in die", "in der", "in das", "in den"],
          errorType: "case",
        },
      ],
      explanation:
        "wo? (ثابت) ⇐ الجرّ in der Stadt. wohin? (حركة) ⇐ النصب in die Stadt. والفعل هو الذي يكشف أيّهما.",
    },
    {
      id: "e20",
      type: "error-correction",
      instructionAr: "صحّح حرف الحركة:",
      wrongSentence: "Ich fahre nach dem Bahnhof.",
      wrongWord: "nach",
      correctWord: "zum",
      options: ["zum", "zur", "ins", "im"],
      errorType: "preposition",
      explanation:
        "nach لا تُستعمل إلّا مع البلدان والمدن وHause، وعلامتها أنّها بلا أداة. والأماكن ذات الأداة تأخذ zu ⇐ zum Bahnhof.",
    },
    {
      id: "e21",
      type: "error-correction",
      instructionAr: "صحّح فعل التنقّل:",
      wrongSentence: "Ich gehe nach Berlin mit dem Zug.",
      wrongWord: "gehe",
      correctWord: "fahre",
      options: ["fahre", "fliege", "komme", "laufe"],
      errorType: "vocabulary",
      explanation:
        "gehen تعني المشي على القدمين، فالجملة تقول إنّك ستمشي إلى برلين. وكلّ ما يسير على الأرض يأخذ fahren.",
    },
    {
      id: "e22",
      type: "word-ordering",
      instructionAr: "رتّب الكلمات لتكوّن سؤالاً مهذّباً عن الطريق:",
      tokens: [
        "Entschuldigung",
        ",",
        "wie",
      ...
      errorType: "word-order",
      explanation:
        "الاستئذان أوّلاً، ثمّ أداة الاستفهام wie في المركز الأوّل والفعل komme في الثاني — قاعدة V2 تحكم السؤال أيضاً.",
    },
    {
      id: "e23",
      type: "matching",
      instructionAr: "صِل كلّ مقصد بحرف الحركة المناسب:",
      errorType: "preposition",
      pairs: [
        { left: "Deutschland (بلد)", right: "nach Deutschland" },
        { left: "der Bahnhof (مكان بأداة)", right: "zum Bahnhof" },
        { left: "das Kino (دخول)", right: "ins Kino" },
        { left: "Hause (البيت، حركة)", right: "nach Hause" },
        { left: "die Apotheke (مكان بأداة)", right: "zur Apotheke" },
      ],
      explanation:
        "nach للبلدان بلا أداة · zu للأماكن ذات الأداة · in للدخول فعلاً · وnach Hause تعبير جامد.",
    },
    {
      id: "e24",
      type: "transformation",
      instructionAr: "استبدل الاسم بضمير المفعول به:",
      prompt: "Ich nehme den Bus. ⇐ (بالضمير)",
      errorType: "pronoun",
      acceptedAnswers: ["Ich nehme ihn.", "Ich nehme ihn"],
      sampleAnswer: "Ich nehme ihn.",
      explanation:
        "der Bus مذكّر في النصب ⇐ ihn. ولاحظ أنّ الضمير يحلّ محلّ الأداة والاسم معاً لا محلّ الاسم وحده.",
    },
    {
      id: "e25",
      type: "multiple-choice",
      instructionAr: "اختر وسيلة النقل بالصيغة الصحيحة:",
      questionDe: "Wie kommst du zur Arbeit? — ___.",
      options: ["Mit dem Bus", "Mit den Bus", "Mit Bus", "Bei dem Bus"],
      correctIndex: 0,
      errorType: "case",
      explanation:
        "mit تطلب الجرّ دائماً بلا استثناء: der Bus ⇐ mit dem Bus. وهي من الحروف السبعة الثابتة.",
    },
    {
      id: "e26",
      type: "fill-blank",
      instructionAr: "أكمل بضمير المفعول به المناسب:",
      errorType: "pronoun",
      template:
        "Das Kino ist neu. Ich finde ___ sehr schön. Und die Haltestelle? Ich sehe ___ nicht.",
      blanks: [
        {
          correct: "es",
          options: ["es", "ihn", "sie", "ihm"],
          errorType: "pronoun",
        },
        {
          correct: "sie",
      ...
      explanation:
        "das Kino محايد ⇐ es؛ die Haltestelle مؤنّثة ⇐ sie. والمحايد والمؤنّث لا يتغيّران بين الرفع والنصب.",
    },
  ],
  fehlerUndTipps: {
    mistakes: [
      {
        wrong: "Ich gehe zu Deutschland.",
        right: "Ich fahre nach Deutschland.",
        whyAr: "البلدان nach دائماً.",
      },
      {
        wrong: "zu Hause للحركة",
        right: "nach Hause للحركة، zu Hause للسكون",
        whyAr: "فرق دقيق مهم: اذهب إلى المنزل = nach Hause.",
      },
      {
        wrong: "in der Stadt للحركة",
        right: "in die Stadt للحركة (wohin?) وin der Stadt للسكون (wo?)",
        whyAr: "قاعدة السكون/الحركة: wo? Dativ، wohin? Akkusativ.",
      },
    ],
    eselsbruecken: [
  ...
  miniTest: [
    ...
    },
    {
      ...
      explanation:
        "Stadt مؤنثة → in die Stadt (نصب للحركة). ins = in+das للمحايد.",
      errorType: "preposition",
    },
    {
      id: "m5",
  ...
  flashcards: [
    ...
    },
    {
      ...
      exampleAr: "اذهبوا مباشرة!",
      level: "A1",
    },
    {
      id: "fc5",
      de: "nach / zu / in",
      ar: "إلى (ثلاثة حروف للحركة)",
      example: "nach Deutschland, zum Bahnhof, ins Kino",
      exampleAr: "إلى ألمانيا، إلى المحطة، إلى السينما",
      level: "A1",
    },
    {
      id: "fc6",
    ...
    },
    {
      ...
      exampleAr: "أذهب بالحافلة إلى العمل.",
      level: "A1",
    },
    {
      id: "fc10",
      ...
      exampleAr: "إلى السوق أذهب مشياً.",
      level: "A1",
    },
    {
      id: "fc11",
      de: "ihn (Akkusativ von er)",
      ar: "إيّاه (ضمير مفعول للمذكّر)",
      example: "Der Bus? Ich nehme ihn.",
      exampleAr: "الحافلة؟ آخذها.",
      level: "A1",
    },
    {
      id: "fc12",
    ...
    },
    {
      ...
      de: "das Institut",
      ar: "المعهد",
      example: "Das Institut ist gleich um die Ecke.",
      exampleAr: "المعهد خلف الزاوية مباشرة.",
      level: "A1",
    },
    {
      id: "fc14",
      ...
      exampleAr: "أين الموقف؟",
      level: "A1",
    },
    {
      id: "fc15",
      de: "steigt … um (umsteigen)",
      ar: "يبدّل وسيلة النقل",
      example: "Ich steige in Köln um.",
      exampleAr: "أبدّل القطار في كولونيا.",
      level: "A1",
    },
    {
      id: "fc16",
      de: "gegenüber von",
      ar: "مقابل",
      example: "Das Institut ist gegenüber von einer Apotheke.",
      exampleAr: "المعهد مقابل صيدلية.",
      level: "A1",
    },
    {
      id: "fc17",
      ...
      exampleAr: "عذراً، كيف أصل إلى المحطة؟",
      level: "A1",
    },
    {
      id: "fc18",
      ...
      exampleAr: "لا أفهم. أيمكنك الإعادة من فضلك؟",
      level: "A1",
    },
    {
      id: "fc19",
    ...
    },
    {
      ...
      exampleAr: "أوّلاً امشِ مستقيماً.",
      level: "A1",
    },
    {
      id: "fc22",
      de: "weit",
      ar: "بعيد",
      example: "Ist das weit von hier?",
      exampleAr: "هل هذا بعيد من هنا؟",
      level: "A1",
    },
    {
      id: "fc23",
      de: "die Kirche",
      ar: "الكنيسة",
      example: "Neben der Kirche ist eine Apotheke.",
      exampleAr: "بجانب الكنيسة صيدلية.",
      level: "A1",
    },
    {
      id: "fc24",
      ...
      exampleAr: "امرأةٌ مع كلبٍ تساعدني.",
      level: "A1",
    },
    {
      id: "fc25",
      de: "Entschuldigung!",
      ar: "عذراً! (لاستيقاف أحد)",
      example: "Entschuldigung, wo ist der Bahnhof?",
      exampleAr: "عذراً، أين المحطّة؟",
      level: "A1",
    },
  ],
  ...
  mediation: [
    {
      ...
      sourceDe:
        "Die U-Bahnlinie 2 fährt vom Bahnhof direkt zum Zentrum. Die Fahrt dauert 10 Minuten. Tickets gibt es am Automaten.",
      taskAr:
        "أرشد سائحاً بالعربية: أي خط مترو، من أين إلى أين، المدة، وأين يشتري التذاكر.",
      modelAnswerAr:
        "«خط المترو 2 ينطلق من المحطة مباشرة إلى المركز. تستغرق الرحلة 10 دقائق. التذاكر من الآلة.»",
      keyPointsAr: [
        "ذكرت خط المترو (2)",
        "نقلت الوجهة والمدة (10 دقائق)",
        "أرشدت لمكان شراء التذاكر",
      ],
    },
  ],
  interaction: [
      ...
      rounds: [
        {
          ...
          options: [
            {
              de: "Gehen Sie geradeaus und dann rechts.",
              ar: "امشِ مباشرة ثم انعطف يميناً.",
              best: true,
              replyDe: "Danke! Und wie weit ist es?",
              replyAr: "شكراً! وكم تبعد؟",
            },
            {
              de: "Der Bahnhof ist in China.",
              ar: "محطة القطار في الصين.",
              best: false,
              replyDe: "Nein, hier in dieser Stadt!",
              replyAr: "لا، هنا في هذه المدينة!",
            },
          ],
        },
        {
          ...
          options: [
            {
              de: "Ungefähr 10 Minuten zu Fuß.",
              ar: "حوالي 10 دقائق مشياً.",
              best: true,
              replyDe: "Perfekt, vielen Dank!",
              replyAr: "ممتاز، شكراً جزيلاً!",
            },
            {
              de: "Sehr weit, 3 Stunden.",
              ar: "بعيدة جداً، 3 ساعات.",
              best: false,
              replyDe: "Das stimmt nicht, es ist nur 10 Minuten.",
              replyAr: "هذا غير صحيح، إنها 10 دقائق فقط.",
            },
          ],
        },
      ],
