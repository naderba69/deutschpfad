...
export const lessonA102: Lesson = {
  ...
  lernziele: [
    ...
    {
      id: "z2",
      de: "Ich kann mein/meine richtig verwenden.",
      ar: "أن أستخدم أدوات الملكية mein/meine بشكل صحيح حسب جنس الاسم.",
    },
    {
      id: "z3",
    ...
    },
    {
      ...
      ar: "أن أسأل عن العائلة: هل لديك إخوة؟",
    },
  ],
  ...
  theory: [
    {
      ...
      examples: [
        ...
        },
        {
          ...
          ar: "ابني/ابنتي اسمه نور. (Kind محايد ⟵ mein)",
        },
        {
      ...
      commonMistakes: [
        {
          ...
          right: "meine Mutter",
          whyAr:
            "الأشهر على الإطلاق. السبب أنّ المتعلّم يفكّر بالعربية «أمّي» فيربط الأداة بنفسه لا بالكلمة. لكنّ die Mutter مؤنّثة، والمؤنّث يوجب النهاية ‑e. الاختبار الفوري: أتقول eine Mutter؟ نعم ⟵ إذن meine Mutter.",
        },
        {
          wrong: "meine Vater",
          right: "mein Vater",
          whyAr:
            "الخطأ المعاكس: إقحام ‑e حيث لا موضع لها. der Vater مذكّر، فالأداة عارية بلا نهاية. وكثيراً ما يقع فيه مَن حفظ meine Mutter ثمّ عمّمها على كلّ شيء. النهاية ‑e للمؤنّث والجمع فقط.",
        },
        {
          wrong: "Ich bin Sara. Meine Bruder heißt Ali.",
          right: "Ich bin Sara. Mein Bruder heißt Ali.",
          whyAr:
            "خطأ أعمق: المتكلّمة أنثى فظنّت أنّ الأداة تتأنّث معها. وهذا هو الالتباس الجوهري في الدرس كلّه — الأداة لا تعرف جنس المتكلّم أصلاً ولا تهتمّ به، بل تنظر إلى الكلمة التي بعدها فحسب. der Bruder مذكّر ⟵ mein، ولو كانت المتكلّمة ملكةً.",
        },
        {
          wrong: "Meine Eltern ist nett.",
          right: "Meine Eltern sind nett.",
          whyAr:
            "الأداة صحّت والفعل أخطأ. die Eltern جمع دائماً ولا مفرد له بهذا المعنى، فيلزمه sind لا ist. والعربي معرّضٌ لهذا لأنّ العربية تُجيز إفراد الفعل مع الجمع غير العاقل («الكتب موجودة»)، والألمانية لا تُجيزه أبداً.",
        },
      ],
      relatedRuleComparison: {
        title: "mein / kein / ein — عائلة واحدة بتصريف واحد",
        content:
          "الفائدة الكبرى في هذا الدرس أنّ ما تتعلّمه ليس قاعدةً واحدة بل **ثلاثاً**. فالأداة النكرة ein، وأداة النفي kein، وكلّ أدوات الملكية (mein, dein, sein, ihr, unser, euer, Ihr) تُصرَّف تصريفاً متطابقاً حرفاً بحرف، ولذلك تُسمّى جميعاً ein‑Wörter. قارن في حالة الرفع: ein/kein/mein Vater — eine/keine/meine Mutter — ein/kein/mein Kind — keine/meine Eltern (ولا وجود لـ ein في الجمع لأنّ «واحداً» لا يُجمع). فإن أتقنت خانةً واحدة أتقنت الثلاث. والفرق الوحيد بينها في الجمع: kein و mein يعملان فيه، أمّا ein فيسقط.",
      },
    },
    {
      id: "t2",
      ...
      examples: [
        {
          ...
          ar: "هل لديك إخوة؟ — نعم، لي أخ وأختان.",
        },
        {
        ...
        },
        {
          ...
          ar: "هذا طفلي. اسمه نور. (Kind محايد ⟵ الضمير es)",
        },
        {
      ...
      commonMistakes: [
        {
          ...
          whyAr:
            "Eltern جمعٌ دائماً ولا مفرد له، فيلزمه sind. والخطأ ناتج عن أنّ الكلمة لا تحمل علامة جمعٍ ظاهرة كـ ‑e أو ‑er فتبدو مفردة. والقاعدة العملية: احفظها من أوّل يوم في جملة كاملة «Meine Eltern sind…» فلا تنفكّ عن sind في ذهنك.",
        },
        {
          wrong: "Mein Vater und meine Mutter sind nett.",
          right: "Meine Eltern sind nett.",
          whyAr:
            "ليست خطأً نحوياً بل ركاكةً أسلوبية. الألمانية تفضّل الاسم الجامع حين يوجد، ولهذا وُضعت Eltern أصلاً. والتعبير المطوَّل يُسمع كترجمةٍ حرفية من لغةٍ أخرى، وامتحان Goethe الشفوي يمنح نقاطاً للتنويع المعجمي.",
        },
        {
          wrong: "die Mädchen ist schön",
          right: "das Mädchen ist schön",
          whyAr:
            "Mädchen محايدة رغم أنّها تدلّ على أنثى، لأنّ كلّ اسمٍ ينتهي بـ ‑chen محايد قطعاً (das Brötchen, das Häuschen). فالنهاية الصرفية أقوى من المعنى في تحديد الجنس الألماني، وهذه قاعدةٌ ستنفعك في مئات الكلمات.",
        },
        {
          wrong: "Ich habe zwei Bruders.",
          right: "Ich habe zwei Brüder.",
          whyAr:
            "قياس نهاية الجمع الإنجليزية ‑s على الألمانية. وجمع Bruder بالإمالة وحدها: Brüder، بلا أيّ نهاية. ونهاية ‑s في الألمانية نادرة ومحصورة في الدخيل غالباً (Autos, Hotels, Handys)، فلا تُعمَّم على الكلمات الأصيلة.",
        },
      ],
      relatedRuleComparison: {
        title: "الاسم المركّب: كيف تعرف جنسه بلا معجم؟",
        content:
          "die Großmutter و der Familienname و das Kinderzimmer كلّها أسماء مركّبة (Komposita)، والألمانية تبني منها ما لا يُحصى. والقاعدة الذهبية: **الجزء الأخير هو الذي يحدّد الجنس والجمع معاً**، والأجزاء السابقة مجرّد وصف. فـ die Großmutter مؤنّثة لأنّ die Mutter مؤنّثة، وجمعها die Großmütter بالإمالة نفسها. و der Familienname مذكّر لأنّ der Name مذكّر، لا لشيءٍ في Familie. وهذه القاعدة تعمل مهما طال المركّب: das Sprachenzentrum محايدة لأنّ das Zentrum محايدة، ولو سبقتها عشر كلمات. فأنت لا تحتاج إلى حفظ جنس المركّبات إطلاقاً — يكفيك جنس آخر جزءٍ فيها، وهذا يوفّر عليك آلاف المداخل المعجمية طوال رحلتك.",
      },
    },
    {
      id: "t3",
  ...
  reading: {
    ...
    glossary: [
      {
        ...
        ar: "الصورة",
        noteAr:
          "محايدة، والجمع die Fotos بنهاية ‑s لأنّها كلمة دخيلة. وتُكتب أيضاً Photo في النصوص القديمة.",
      },
      {
        de: "die Großeltern",
        ar: "الجدّان",
        noteAr:
          "جمعٌ دائماً كـ Eltern، ولا مفرد له. والمفردان: der Großvater و die Großmutter.",
      },
      {
      ...
      },
      {
        ...
        ar: "متزوّج",
        noteAr:
          "صفة تُستعمل مع sein: Sie sind verheiratet. وضدّها ledig (أعزب) — وكلتاهما تردان في استمارة Familienstand.",
      },
      {
        de: "studieren",
        ar: "يدرس (في الجامعة)",
      ...
      },
      {
        ...
        ar: "الصديقة / الخليلة",
        noteAr:
          "غامضة عمداً: قد تعني صديقةً وقد تعني شريكة حياة. والسياق يحسم، ويُوضَّح بـ eine Freundin (صديقة) مقابل meine Freundin (خليلتي).",
      },
    ],
    questions: [
      {
      ...
      },
      {
        ...
        correctIndex: 2,
        explanation:
          "النصّ يقول: «Ihr Mann ist nicht auf dem Foto, denn er fotografiert». وكلمة ihr هنا ملكية تعود على الخالة، لأنّ بعدها اسماً لا فعلاً. أمّا الجدّ والجدّة والخالة فكلّهم مذكورون حاضرين.",
        optionExplanations: [
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation:
          "النصّ: «Ich habe zwei Geschwister: einen Bruder und eine Schwester». وكلمة Geschwister جامعة تشمل الذكور والإناث معاً، ولا مفرد لها — فلا يُقال ein Geschwister إطلاقاً.",
        optionExplanations: [
      ...
      },
      {
        ...
        correctIndex: 2,
        explanation:
          "النصّ: «jeden Sonntag telefoniere ich mit meinen Eltern». ولاحظ ترتيب الكلمات: ظرف الزمان في المركز الأوّل فانزاح الفاعل ich بعد الفعل — وهي قاعدة المركز الثاني التي درستَها في الدرس الأوّل.",
        optionExplanations: [
    ...
    discussionAr:
      "صِف صورةً حقيقية من هاتفك بالألمانية على منوال أميرة: ابدأ بـ Das ist ein Foto von…، ثمّ وزّع الأشخاص بـ links / rechts / in der Mitte، واذكر لكلٍّ اسمه وعمره ومهنته وصلته بك. اشترط على نفسك استعمال mein/meine ستّ مرّات على الأقلّ، وsein أو ihr مرّتين حين تتحدّث عن ملكية شخصٍ آخر. ثمّ راجع: هل نظرتَ إلى الكلمة التي بعد الأداة في كلّ مرّة؟",
  },
    ...
    items: [
      {
        de: "ich",
        ar: "أنا",
        note: "ch بعد i تُنطق «ش» خفيفة جداً (أقرب إلى «خ» ناعمة): إيخ",
      },
      ...
      { de: "Tochter", ar: "الابنة", note: "ch بعد o تُنطق «خ» حلقية: توخ-تر" },
      {
        de: "Geschwister",
        ar: "الإخوة",
        note: "ge في البداية تُنطق «غِ» خفيفة: غِشڤيس-تر",
      },
    ],
  ...
  writing: [
    {
      ...
      explanation:
        "لتقديم شخص: Das ist mein + صلة القرابة. ولذكر الاسم: (الاسم) heißt.",
      errorType: "grammar",
    },
    {
      id: "w2",
  ...
  practiceBank: [
    ...
    },
    {
      ...
      explanation:
        "Mutter مؤنثة → Meine Mutter. هذا أشهر خطأ للمتعلم العربي في هذا الدرس.",
      errorType: "gender",
    },
    {
      id: "e7",
    ...
    },
    {
      ...
      template: "Lena ist meine Freundin. ___ Vater arbeitet in Berlin.",
      blanks: [{ correct: "Ihr", options: ["Ihr", "Ihre", "Sein", "Seine"] }],
      explanation:
        "المالكة لينا وهي مؤنّثة ⟵ الجذر ihr. والمملوك Vater مذكّر ⟵ بلا نهاية. فالنتيجة Ihr Vater. الجذر للمالك والنهاية للمملوك.",
      errorType: "pronoun",
    },
    {
      id: "e14",
      ...
      options: [
        ...
        "Ali und ihre Mutter wohnen hier",
      ...
      optionExplanations: [
        ...
        undefined,
        "ihre تعني «أمّها» والمالك هنا علي.",
    ...
    },
    {
      ...
      explanation:
        "مخاطبة شخصٍ بلقب Frau أو Herr توجب الصيغة الرسمية Ihr‑ بحرفٍ كبير. والمملوك Tochter مؤنّث فتلزمه النهاية ‑e: Ihre Tochter.",
      errorType: "pronoun",
    },
    {
      id: "e16",
    ...
    mistakes: [
      {
        ...
        whyAr:
          "الأسماء المؤنثة (die) تأخذ meine دائماً. المرأة والأنثى = e في النهاية!",
      },
      {
        wrong: "Meine Eltern ist nett.",
        right: "Meine Eltern sind nett.",
  ...
  miniTest: [
    {
      ...
      correctIndex: 0,
      explanation:
        "Vater مذكر → mein Vater. (deine/eine مع مؤنث أو أسماء أخرى).",
      errorType: "gender",
    },
    {
      id: "m2",
  ...
  mediation: [
    {
      ...
      taskAr:
        "أخبر صديقاً بالعربية عن عائلة الشخص: الأسماء، الأعمار، وعدد الإخوة والأخوات.",
      modelAnswerAr:
      ...
      rounds: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              ar: "لا أملك عائلة.",
              best: false,
              replyDe: "Das ist traurig. Jeder hat eine Familie.",
              replyAr: "هذا محزن. كل شخص لديه عائلة.",
            },
          ],
        },
        {
          ...
          options: [
            {
              de: "Mein Bruder ist 20 und meine Schwester ist 15.",
              ar: "أخي عمره 20 وأختي 15.",
              best: true,
              replyDe: "Schön! Und deine Eltern?",
              replyAr: "جميل! ووالداك؟",
            },
            {
              de: "Sie sind alt.",
              ar: "إنهما كبيران.",
              best: false,
              replyDe: "Wie alt genau?",
              replyAr: "كم عمرهما بالضبط؟",
            },
          ],
        },
        {
          ...
          options: [
            {
              ...
              best: true,
              replyDe: "Sehr interessante Berufe!",
              replyAr: "مهن مثيرة للاهتمام!",
            },
            {
              de: "Sie sind zu Hause.",
              ar: "إنهما في المنزل.",
              best: false,
              replyDe: "Und ihre Berufe?",
              replyAr: "وما مهنتهما؟",
            },
          ],
        },
