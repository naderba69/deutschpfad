...
export const lessonA101: Lesson = {
  ...
  miniTest: [
    ...
    },
    {
      ...
      wrongSentence: "Wo du wohnst?",
      wrongWord: "du wohnst",
      correctWord: "wohnst du",
      options: ["wohnst du", "du wohnen", "wohnt du"],
      explanation: "في سؤال W يأتي الفعل مباشرة بعد كلمة السؤال ثم الفاعل: Wo wohnst du? والفعل يوافق du بالنهاية st-.",
      errorType: "word-order",
    },
  ],
