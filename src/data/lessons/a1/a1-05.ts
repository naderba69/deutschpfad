...
export const lessonA105: Lesson = {
  ...
  lernziele: [
    {
      id: "z1",
      de: "Ich kann meinen Tagesablauf beschreiben.",
      ar: "أن أصف يومي: أستيقظ، أتناول الفطور، أذهب إلى العمل...",
    },
    {
      id: "z2",
      de: "Ich kann trennbare Verben benutzen.",
      ar: "أن أستخدم الأفعال المنفصلة (aufstehen, fernsehen) بشكل صحيح.",
    },
    {
      id: "z3",
      de: "Ich kann die Uhrzeit sagen.",
      ar: "أن أقول الوقت بالألمانية (Es ist acht Uhr).",
    },
    {
      id: "z4",
      de: "Ich kann sagen: am Morgen, am Nachmittag, am Abend.",
      ar: "أن أحدد أوقات اليوم (صباحاً، ظهراً، مساءً).",
    },
  ],
  ...
  einfuehrung: {
    ...
    connectionToPreviousAr:
      "تعلمت sein وhaben وتصريف الأفعال المنتظمة. اليوم أفعال «منفصلة» تغيّر مكان البادئة — وكلها أفعال يومية أساسية.",
    activateVocabulary: [
      ...
      examples: [
        {
          ...
          ar: "أستيقظ كلّ يوم في السابعة. (البادئة في الآخر)",
        },
        {
        ...
        },
        {
          ...
          ar: "تتسوّق يوم السبت في السوبرماركت. (البادئة ein بعد كلّ التفاصيل)",
        },
        { de: "Der Kurs fängt um neun Uhr an.", ar: "يبدأ الدرس في التاسعة." },
        {
          de: "Ich muss morgen früh aufstehen.",
          ar: "عليّ أن أستيقظ باكراً غداً. (مع فعل ناقص ⟵ لا انفصال)",
        },
        {
      ...
      commonMistakes: [
        {
          ...
          whyAr:
            "الخطأ الأوّل والأشيع: إبقاء الفعل موحّداً كما في العربية. لكنّ البادئة المنفصلة تُقذف إلى آخر الجملة والفعل يُصرَّف وحده في المركز الثاني. تخيّل أنّ الفعل ينشقّ نصفين والنصف الثاني يذهب إلى النهاية.",
        },
        {
          wrong: "Ich stehe auf um sieben.",
          right: "Ich stehe um sieben auf.",
          whyAr:
            "فُصلت البادئة لكنّها لم تُرسَل بعيداً بما يكفي. والقاعدة أنّها تحتلّ **آخر** موضعٍ في الجملة، بعد كلّ التفاصيل من زمانٍ ومكانٍ ومفعول. فكلّما طالت الجملة ابتعدت البادئة.",
        },
        {
          wrong: "Ich verstehe das auf.",
          right: "Ich verstehe das.",
          whyAr:
            "إفراطٌ في تطبيق القاعدة على بادئةٍ غير منفصلة. و ver‑ من السبع التي لا تنفصل أبداً (be‑ge‑er‑ver‑zer‑ent‑emp)، وعلامتها أنّ النبر يقع على الجذر لا عليها: ver‑STE‑hen.",
        },
        {
          wrong: "Ich muss früh stehe auf.",
          right: "Ich muss früh aufstehen.",
          whyAr:
            "خلط بنيتين: مع الفعل الناقص يبقى الفعل المنفصل **مصدراً موحّداً** في آخر الجملة، فلا يُصرَّف ولا ينفصل. والقاعدة العامّة: موضع آخر الجملة محجوزٌ لعنصرٍ واحد فقط، فإن شغله المصدر لم تبقَ فيه البادئة منفردةً.",
        },
      ],
      relatedRuleComparison: {
        title: "قوس الجملة (Satzklammer): البنية التي تحكم الألمانية كلّها",
        content:
          "ما تراه اليوم مع الأفعال المنفصلة ليس قاعدةً معزولة بل **النمط البنيوي الأساسي للجملة الألمانية**. القاعدة: عنصرٌ **مصرَّف** في المركز الثاني، وعنصرٌ **غير مصرَّف** في آخر الجملة، وبينهما «حشو» (Mittelfeld) فيه الزمان والمكان والمفعول. وستراها في أربعة سياقاتٍ على الأقلّ: (١) الفعل المنفصل — Ich **stehe** um sieben **auf**. (٢) الفعل الناقص — Ich **muss** um sieben **aufstehen**. (٣) الماضي التامّ — Ich **bin** um sieben **aufgestanden**. (٤) المستقبل — Ich **werde** um sieben **aufstehen**. أربع قواعد مختلفة تماماً في المعنى، وبنيةٌ واحدة في الشكل. ولهذا فإنّ إتقانك للفعل المنفصل اليوم هو في الحقيقة إتقانٌ مسبق لثلاث قواعد قادمة — استثمرْه ولا تعدّه عبئاً.",
      },
    },
    {
      id: "t2",
      ...
      examples: [
        ...
        },
        {
          ...
          ar: "أنام سيّئاً في الليل. (الاستثناء الوحيد: in der)",
        },
        {
      ...
      commonMistakes: [
        {
          ...
          whyAr:
            "أخطر خطأٍ عملي في الدرس لأنّ نتيجته موعدٌ ضائع بساعةٍ كاملة. الألمانية تعدّ نحو الساعة القادمة: halb neun = نصف الطريق إلى التاسعة. والقاعدة التصحيحية: كلّما سمعت halb اطرح واحداً من العدد المذكور.",
        },
        {
          wrong: "in der Morgen",
          right: "am Morgen",
          whyAr:
            "ترجمة حرفية لـ«في الصباح». والصواب am (= an + dem) لأنّ der Morgen مذكّر مجرور. وتنطبق على Vormittag و Mittag و Nachmittag و Abend، ويشذّ الليل وحده: in der Nacht لأنّ die Nacht مؤنّثة.",
        },
        {
          wrong: "Ich arbeite von acht zu sechzehn Uhr.",
          right: "Ich arbeite von acht bis sechzehn Uhr.",
          whyAr:
            "خلط zu بـ bis. والمدى الزمني أو المكاني يُصاغ بـ von … bis … حصراً. أمّا zu فللاتّجاه نحو شخصٍ أو مؤسّسة: ich gehe zum Arzt, zur Schule.",
        },
        {
          wrong: "Es ist acht dreißig Uhr.",
          right: "Es ist acht Uhr dreißig. / Es ist halb neun.",
          whyAr:
            "خطأ في موضع كلمة Uhr. والبنية الرسمية ثابتة: العدد + **Uhr** + الدقائق، فتقول acht Uhr dreißig. أمّا في الصيغة اليومية فتسقط Uhr كلّياً: halb neun.",
        },
      ],
      relatedRuleComparison: {
        title: "am · um · in · von…bis — أدوات الزمن الأربع وكيف لا تخلطها",
        content:
          "الألمانية توزّع حروف الزمن بحسب **حجم الوحدة الزمنية**، والتوزيع منتظم تماماً: **um** للساعة الدقيقة (um acht Uhr, um halb neun) — تخيّلها عقرباً يشير إلى نقطة. **am** لأجزاء اليوم وأيّام الأسبوع والتواريخ (am Morgen, am Montag, am 3. Mai) — والاستثناء الوحيد: in der Nacht. **im** للشهور والفصول (im Januar, im Sommer). **von … bis …** للمدى (von acht bis sechzehn Uhr, von Montag bis Freitag). ثمّ حروفٌ أدقّ: **ab** = ابتداءً من (ab morgen)، و **seit** = منذ (seit zwei Jahren، للماضي المستمرّ)، و **gegen** = نحو/تقريباً (gegen acht)، و **nach/vor** = بعد/قبل (nach dem Essen). ولاحظ التدرّج الجميل: كلّما كبرت الوحدة الزمنية انتقلت من um إلى am إلى im. وثلاث كلماتٍ تُستعمل **بلا أيّ حرف**: heute, morgen, gestern — فلا تقل «am heute».",
      },
    },
    {
      id: "t3",
      ...
      table: {
        ...
        rows: [
          {
            label: "immer",
            cells: ["دائماً (100٪)", "Ich frühstücke immer um sieben."],
          },
          {
            label: "meistens",
            cells: ["غالباً (80٪)", "Ich gehe meistens zu Fuß."],
          },
          { label: "oft", cells: ["كثيراً (60٪)", "Wir kochen oft zusammen."] },
          {
            label: "manchmal",
            cells: ["أحياناً (40٪)", "Ich sehe manchmal fern."],
          },
          {
            label: "selten",
            cells: ["نادراً (10٪)", "Er steht selten früh auf."],
          },
          {
            label: "nie",
            cells: ["أبداً (0٪)", "Ich trinke nie Kaffee am Abend."],
          },
        ],
      },
      examples: [
        {
          ...
          ar: "أستيقظ دائماً في السادسة. (الظرف بعد الفعل مباشرةً)",
        },
        {
        ...
        },
        {
          ...
          ar: "لا أنام قبل منتصف الليل أبداً. (nie وحدها بلا nicht)",
        },
        {
          de: "Montags habe ich immer Deutschkurs.",
          ar: "عندي درس ألماني كلّ اثنين. (montags بحرف صغير)",
        },
        {
      ...
      commonMistakes: [
        {
          ...
          whyAr:
            "وُضع الظرف بين الفاعل والفعل، وهذا موضعٌ محظور في الألمانية لأنّه يزيح الفعل عن المركز الثاني. والموضع الصحيح: **بعد** الفعل المصرَّف مباشرةً. تذكّر أنّ لا شيء يفصل بين المركز الأوّل والفعل.",
        },
        {
          wrong: "Manchmal ich sehe fern.",
          right: "Manchmal sehe ich fern.",
          whyAr:
            "نقلٌ حرفي للترتيب العربي «أحياناً أنا أشاهد». لكنّ تقديم الظرف يشغل المركز الأوّل، فيلزم أن يحتلّ الفعل المركز الثاني، فينزاح الفاعل إلى الثالث. وهذه قاعدة V2 التي تحكم كلّ جملةٍ خبرية ألمانية بلا استثناء.",
        },
        {
          wrong: "Ich gehe nie nicht ins Kino.",
          right: "Ich gehe nie ins Kino.",
          whyAr:
            "نفيٌ مزدوج على المنوال العربي («لم أذهب أبداً»). و nie تحمل النفي في ذاتها، فإضافة nicht تُبطله منطقياً وتُعدّ خطأً فاضحاً في الألمانية المعيارية. اختر أداةً واحدة.",
        },
        {
          wrong: "Ich fahre zur Arbeit jeden Morgen mit dem Bus.",
          right: "Ich fahre jeden Morgen mit dem Bus zur Arbeit.",
          whyAr:
            "ترتيبٌ عربي: المكان أوّلاً والزمان آخراً. والترتيب المحايد في الألمانية TeKaMoLo — الزمان ثمّ الكيفية ثمّ المكان. والجملة الأولى ليست خاطئة نحواً لكنّها تُسمع غريبة، وهي علامةٌ واضحة على الترجمة من لغةٍ أخرى.",
        },
      ],
      relatedRuleComparison: {
        title: "المركز الأوّل (Vorfeld): من يجلس فيه ولماذا؟",
        content:
          "الجملة الخبرية الألمانية تُبنى على مبدأٍ واحد لا يُخرَق: **الفعل المصرَّف في المركز الثاني**. أمّا المركز الأوّل (Vorfeld) فهو **مقعدٌ واحد يشغله عنصرٌ واحد فقط**، وأنت حرّ في اختيار مَن يجلس فيه — والاختيار له معنى. فقد يجلس فيه: الفاعل (Ich stehe früh auf — محايد)، أو ظرف زمان (Jeden Tag stehe ich früh auf — تأكيد على الاعتياد)، أو ظرف تكرار (Manchmal stehe ich spät auf — تأكيد على الاستثناء)، أو ظرف مكان (In Tunis wohne ich nicht mehr)، أو حتّى المفعول به (Das Buch kenne ich — تأكيد وتقديم للمعلوم). وفي كلّ حالةٍ **يبقى الفعل ثانياً ويُدفَع ما تبقّى إلى ما بعده**. فالمركز الأوّل هو أداة التركيز والربط في الألمانية: ما تضعه فيه هو ما تعلّق عليه الجملة. وهذا ما يجعل الألمانية مرنةً في المعنى رغم صرامتها في الشكل — ومَن أتقن هذا المبدأ الواحد أتقن بناء الجملة الألمانية كلّه.",
      },
    },
  ],
  ...
  reading: {
    ...
    glossary: [
      ...
      },
      {
        ...
        noteAr:
          "محايد لأنّه تصغير بـ‑chen، وكلّ مصغّر محايد مهما كان أصل كلمته. وجمعه بلا تغيير: die Brötchen.",
      },
      {
        de: "die U-Bahn",
      ...
      },
      {
        ...
        ar: "تستغرق الرحلة…",
        noteAr:
          "الفعل dauern يخصّ المدّة الزمنية: Die Fahrt dauert 20 Minuten. ولا يُستعمل للأشخاص.",
      },
      {
        de: "Es ist viel los.",
      ...
      },
      {
        ...
        ar: "استراحة الغداء",
        noteAr:
          "مؤنّثة لأنّ die Pause مؤنّثة. والفعل المصاحب: Pause machen (يأخذ استراحة) لا nehmen.",
      },
      {
        de: "die Kantine",
        ar: "المقصف / مطعم المؤسّسة",
        noteAr:
          "مؤنّثة بـ‑e. وتوجد في أغلب المستشفيات والشركات الألمانية بأسعار مدعومة.",
      },
      {
        de: "die Besprechung",
        ar: "الاجتماع",
    ...
    questions: [
      {
        ...
        correctIndex: 1,
        explanation:
          "النصّ: «Ich stehe immer um halb sechs auf». وكلمة halb sechs تعني الخامسة والنصف لا السادسة والنصف — لأنّ الألمانية تعدّ نحو الساعة القادمة. القاعدة: اطرح واحداً.",
        optionExplanations: [
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation:
          "ظرف الزمان شغل المركز الأوّل، وقاعدة V2 توجب أن يبقى الفعل المصرَّف في المركز الثاني، فانزاح الفاعل إلى الثالث. وهذه القاعدة تعمل في كلّ جملةٍ خبرية ألمانية.",
        optionExplanations: [
    ...
    items: [
      {
        ...
        lines: [
          ...
          {
            speaker: "Sami",
            de: "Am Mittag esse ich um zwölf Uhr.",
            ar: "ظهراً آكل في الثانية عشرة.",
          },
          {
            speaker: "Sami",
  ...
  pronunciation: {
    ...
    items: [
      {
        de: "aufstehen",
        ar: "يستيقظ",
        note: "st في بداية المقطع = شت: آوف-شتيهن",
      },
      {
        de: "frühstücken",
        ar: "يتناول الفطور",
        note: "früh = فريو (ü طويل) + st = شت",
      },
      ...
      { de: "der Morgen", ar: "الصباح", note: "r حلقية خفيفة + g = غ: مورغن" },
      {
        de: "fernsehen",
        ar: "يشاهد التلفاز",
        note: "sehen = زيهن (s بين حرفين علة = ز)",
      },
      {
        de: "das Frühstück",
        ar: "الفطور",
        note: "ü في كلا المقطعين: فريو-شتوك",
      },
    ],
    ...
    shadowing: [
      ...
      },
      {
        ...
        ar: "أرتّب الغرفة.",
        tip: "räume = رُويْمِه (äu = أُوي)",
      },
      {
        de: "Der Kurs fängt um neun an.",
        ar: "الدورة تبدأ في التاسعة.",
        tip: "fängt = فِنگت (ä) — an في النهاية",
      },
    ],
  },
  ...
  practiceBank: [
    ...
    },
    {
      ...
      explanation:
        "aufstehen فعل منفصل: البادئة auf تذهب إلى نهاية الجملة — Ich stehe um sieben Uhr auf.",
      errorType: "word-order",
    },
    {
      id: "e6",
    ...
    },
    {
      ...
      correctIndex: 0,
      explanation:
        "الفاعل ثم الفعل المصرَّف ثم ظرف التكرار: Ich stehe immer …، والبادئة auf تُغلق الجملة.",
      optionExplanations: [
        undefined,
    ...
    },
    {
      ...
      template:
        "Ich trinke ___ Kaffee (100٪). Wir kochen ___ zusammen (40٪). Er kommt ___ zu spät (0٪).",
      blanks: [
      ...
      explanation:
        "immer = 100٪ · manchmal = نحو 40٪ · nie = 0٪. لاحظ أنّ الثلاثة تقع بعد الفعل المصرَّف مباشرةً.",
      errorType: "vocabulary",
    },
    {
      id: "e14",
      ...
      explanation:
        "الظرف تصدّر الجملة، فوجب أن يبقى الفعل ثانياً وينزاح الفاعل بعده: Manchmal gehe ich …",
      errorType: "word-order",
    },
    {
      id: "e15",
    ...
    },
    {
      ...
      correctIndex: 1,
      explanation:
        "halb تعدّ نحو الساعة القادمة: halb acht = نصف الطريق إلى الثامنة = ٧:٣٠. القاعدة العملية: اطرح ساعةً من العدد المذكور.",
      optionExplanations: [
    ...
    },
    {
      ...
      explanation:
        "المدى الزمني يُصاغ بـ von … bis … حصراً. أمّا zu فللاتّجاه نحو شخصٍ أو مؤسّسة: ich gehe zum Arzt.",
      errorType: "preposition",
    },
    {
      id: "e20",
      ...
      explanation:
        "أجزاء اليوم تأخذ am (= an + dem)، ويشذّ الليل وحده لأنّ die Nacht مؤنّثة فيصير in der Nacht.",
      errorType: "preposition",
    },
    {
      id: "e21",
    ...
    mistakes: [
      {
        ...
        whyAr: "البادئة ذيل يذهب لنهاية الجملة دائماً.",
      },
      {
      ...
      {
        wrong: "am die Nacht (قلتها مع الليل)",
        right: "in der Nacht",
        whyAr: "الليل استثناء: in der Nacht بدل am.",
      },
    ],
    eselsbruecken: [
  ...
  miniTest: [
    ...
    },
    {
      ...
      explanation:
        "الترتيب الصحيح: الفعل + بقية الجملة + البادئة في النهاية: Ich stehe um halb sieben auf.",
      errorType: "word-order",
    },
    {
      id: "m5",
  ...
  flashcards: [
    ...
    },
    {
      ...
      exampleAr: "أستيقظ دائماً باكراً.",
      level: "A1",
    },
    {
      id: "fc10",
    ...
    {
      id: "fc13",
      de: "in der Nacht (لا am!)",
      ar: "في الليل — الاستثناء الوحيد",
    ...
    },
    {
      ...
      example: "Montags habe ich Deutschkurs.",
      exampleAr: "عندي درس ألماني كلّ اثنين.",
      level: "A1",
    },
    {
      id: "fc15",
      de: "anrufen / abholen / mitnehmen",
      ar: "يتّصل / يقلّ من مكان / يأخذ معه",
  ...
  mediation: [
    {
      ...
      modelAnswerAr:
        "«يستيقظ في السادسة، يفطر في السابعة، يبدأ العمل في الثامنة، وفي المساء يشاهد التلفاز.»",
      keyPointsAr: [
        "نقلت أوقات الاستيقاظ والإفطار",
        "ذكرت بداية العمل (8)",
        "نقلت نشاط المساء",
      ],
    },
      ...
      rounds: [
        {
          ...
          options: [
            ...
            {
              de: "Ich stehe auf um 7 Uhr.",
              ar: "أستيقظ أنا في السابعة.",
              best: false,
              replyDe: "Achte auf die Wortstellung: Ich stehe um 7 Uhr auf.",
              replyAr: "انتبه لترتيب الكلمات: Ich stehe um 7 Uhr auf.",
            },
          ],
        },
        {
          ...
          options: [
            ...
            {
              de: "Ich arbeite bis Mitternacht.",
              ar: "أعمل حتى منتصف الليل.",
              best: false,
              replyDe: "Das ist sehr viel Arbeit!",
              replyAr: "هذا كثير من العمل!",
            },
          ],
        },
      ],
