...
export const lessonA100: Lesson = {
  ...
  lernziele: [
    {
      id: "z1",
      de: "Ich kann das Alphabet buchstabieren.",
      ar: "أن أتهجّى الحروف الألمانية الستة والعشرين بصوت صحيح.",
    },
    {
      id: "z2",
      de: "Ich kann die Umlaute ä, ö, ü aussprechen.",
      ar: "أن أنطق الحروف المعلمة ä وö وü نطقاً صحيحاً (أصعب ما يواجه العربي).",
    },
    {
      id: "z3",
      de: "Ich kenne die wichtigsten Laute: ch, sch, ei, ie, eu, äu, sp, st, pf, tz, ß.",
      ar: "أن أتقن الأصوات المركبة الأساسية التي لا وجود لها في العربية.",
    },
    {
      id: "z4",
      de: "Ich kann meinen Namen auf Deutsch buchstabieren.",
      ar: "أن أتهجّى اسمي بالألمانية (مهم جداً في الهاتف والاستمارات).",
    },
  ],
  ...
  einfuehrung: {
    ...
    connectionToPreviousAr:
      "هذا درسك التأسيسي الأول — بعده مباشرة تتعلم التحيات والتعارف في الدرس A1-01.",
    activateVocabulary: [
  ...
  theory: [
    {
      ...
      table: {
        ...
        rows: [
          ...
          { label: "F f", cells: ["ف", "das Feuer (نار)"] },
          {
            label: "G g",
            cells: [
              "گ (جيم قوية مثل الجيم المصرية — ليست غيناً عربية)",
              "der Garten (حديقة)",
            ],
          },
          ...
          {
            label: "L l",
            cells: ["ل (ملامسة اللسان للأسنان)", "die Lampe (مصباح)"],
          },
          ...
          {
            label: "Q q",
            cells: ["كو (تأتي دائماً مع u)", "die Qualität (جودة)"],
          },
          {
            label: "R r",
            cells: ["ر (حلقية قليلاً أو لثوية)", "der Raum (غرفة/فضاء)"],
          },
          ...
          {
            label: "V v",
            cells: ["ف (غالباً) / ڤ في الدخيل", "der Vogel (طائر)"],
          },
          ...
          { label: "Ü ü", cells: ["يُو (شفتان مقربتان)", "die Tür (باب)"] },
          {
            label: "ß",
            cells: [
              "س (مهموسة — علامة كتابية لا صوت مستقل؛ تدل على أن العلة قبلها طويل)",
              "die Straße (شارع)",
            ],
          },
        ],
      ...
      examples: [
        {
          de: "Mein Name ist Sami. — Wie schreibt man das?",
          ar: "اسمي سامي. — كيف يُكتب ذلك؟",
        },
        {
          de: "S wie Samuel, A wie Anton, M wie Martha, I wie Ida.",
          ar: "س كما في صموئيل… (طريقة التهجّي المعيارية في الهاتف)",
        },
        {
          de: "Buchstabieren Sie bitte Ihren Nachnamen!",
          ar: "تهجَّ اسم عائلتك من فضلك!",
        },
        {
          de: "Ich wohne in der Bahnhofstraße.",
          ar: "أسكن في شارع المحطة. (ß بعد علّة طويلة)",
        },
        { de: "Die Tür ist offen.", ar: "الباب مفتوح. (ü)" },
        {
          de: "Das Mädchen ist schön.",
          ar: "الفتاة جميلة. (ä ثمّ ö في جملة واحدة)",
        },
        {
          de: "Mutter — Mütter. Hören Sie den Unterschied?",
          ar: "أمّ — أمّهات. أتسمع الفرق؟ (الإمالة علامة جمع)",
        },
        {
          de: "Herr Müller schreibt sich M-U-E-L-L-E-R.",
          ar: "السيد مولر يُكتب اسمه M-U-E-L-L-E-R. (البديل عند غياب ü)",
        },
      ],
      ...
      commonMistakes: [
        {
          wrong: "نطق W كـ«و» إنجليزية: Wasser = ووسر",
          right: "W تُنطق «ڤ» دائماً: Wasser = ڤاسّر",
          whyAr:
            "السبب أنّ أغلب العرب تعلّموا الإنجليزية أوّلاً، فرسخت قيمة W الإنجليزية. والألمانية عكستها تماماً: W = ڤ، و V = ف. فحرفٌ واحد يقلب المعنى: Wein (خمر) ≠ fein (رقيق). وهذا أشيع خطأ نطقيّ على الإطلاق.",
        },
        {
          wrong: "نطق V كـ«ڤ» في كلّ موضع: Vater = ڤاتر",
          right: "V = «ف» في الكلمة الألمانية الأصيلة: Vater = فاتر",
          whyAr:
            "القاعدة العملية: V في الكلمات الجرمانية الأصيلة (Vater, Vogel, viel, von, vier) تُنطق «ف». أمّا في الدخيل اللاتيني (Vase, Villa, Vitamin, Vulkan) فتُنطق «ڤ». وهذا استثناءٌ مبرَّر تاريخياً لا اعتباط فيه: الأصل يحدّد النطق.",
        },
        {
          wrong: "نطق s بين حرفَي علّة «س»: lesen = ليسن",
          right: "s المجهورة «ز»: lesen = ليزن، Hose = هوزه",
          whyAr:
            "العربي يقرأ الحرف بقيمته الثابتة كما في لغته، ولا يتوقّع أن يتغيّر الصوت بحسب الموقع. لكنّ s الألمانية مجهورة في أوّل الكلمة وبين حرفَي علّة، ومهموسة في آخرها وقبل حرفٍ صامت. وقاعدة الاستماع: إن سمعت «ز» فاكتب s، فحرف z الألماني ينطق «تس» لا «ز» أبداً.",
        },
        {
          wrong: "نطق ß كـ«ز»: Straße = شترازه",
          right: "ß دائماً «س» حادّة: Straße = شتراسه",
          whyAr:
            "شكل ß يشبه حرف بيتا اليونانية فيوحي بصوتٍ مجهور، والحقيقة عكسها: ß هي أشدّ صور s همساً وأثبتها، ولا تُجهر أبداً مهما كان موقعها. وهي علامةٌ إملائية أيضاً: ما قبلها حرف علّة طويل (Straße) أو مزدوج (weiß)، بينما ss تأتي بعد علّة قصيرة (Wasser, muss).",
        },
      ],
      relatedRuleComparison: {
        title: "ß أم ss؟ القاعدة بعد إصلاح الإملاء 1996",
        content:
          "الاختيار بينهما ليس ذوقاً بل يحكمه **طول الحرف الذي قبلهما**: بعد علّة طويلة أو صوت مزدوج تُكتب ß (Straße, groß, weiß, Fuß)، وبعد علّة قصيرة تُكتب ss (Wasser, muss, dass, Fluss). ولهذا كُتبت daß قديماً وصارت dass بعد الإصلاح، لأنّ الـ a فيها قصيرة. وفي **سويسرا وليختنشتاين** أُلغيت ß كلّياً وحلّت ss محلّها في كلّ موضع — فإن رأيت Strasse على لافتة فأنت غالباً في زيورخ لا في برلين. وفي الحروف الكبيرة كلّها تُكتب SS تقليدياً (STRASSE)، وإن أُقرّ الحرف الكبير ẞ رسمياً سنة 2017 فاستعماله نادر.",
      },
    },
    {
      id: "t2",
      ...
      table: {
        ...
        rows: [
          ...
          {
            label: "ch (بعد i,e)",
            cells: ["ش ناعمة جداً (إيخ)", "ich, echt", "أنا، حقيقي"],
          },
          {
            label: "ch (بعد a,o,u)",
            cells: ["خ حلقية", "Buch, Nacht", "كتاب، ليل"],
          },
      ...
      examples: [
        {
          de: "Mein Freund heißt Rainer.",
          ar: "صديقي اسمه راينر. (ei ثلاث مرّات: ماين، فرُويند، راينر)",
        },
        { de: "Ich liebe die Musik.", ar: "أحبّ الموسيقى. (ie = إي ممدودة)" },
        {
          de: "Die Schule ist in der Stadt.",
          ar: "المدرسة في المدينة. (sch = ش، St- = شت)",
        },
        {
          de: "Ich spreche nicht viel Deutsch.",
          ar: "لا أتكلّم الألمانية كثيراً. (Spr- = شپر، ch الناعمة مرّتين)",
        },
        {
          de: "Das Buch ist auch nicht neu.",
          ar: "الكتاب ليس جديداً أيضاً. (خاء في Buch وauch، وشين في nicht)",
        },
        {
          de: "Die Katze sitzt auf dem Pferd.",
          ar: "القطّة تجلس على الحصان. (tz و pf)",
        },
        {
          de: "Es ist zwanzig nach zehn.",
          ar: "الساعة العاشرة وعشرون دقيقة. (z = تس في ثلاثة مواضع)",
        },
        {
          de: "Guten Tag und auf Wiedersehen!",
          ar: "طاب يومك وإلى اللقاء! (Tag = تاك، und = أونت — همس الأواخر)",
        },
      ],
      comparisonWithArabic:
      ...
      commonMistakes: [
        {
          wrong: "نطق ei كـ«إي»: mein = مين",
          right: "ei = «آي»: mein = ماين، nein = ناين",
          whyAr:
            "العين تقرأ e ثمّ i فتُنتج «إي» قياساً على الإنجليزية والفرنسية. لكنّ ei الألمانية صوتٌ مزدوج ثابت يبدأ مفتوحاً وينتهي مغلقاً = «آي». وخطورة الخطأ أنّه يخلط بين كلمتين موجودتين معاً: nein (لا) و nie (أبداً) — فتقول «أبداً» وأنت تريد «لا».",
        },
        {
          wrong: "نطق ich كـ«إخ» بخاء عربية",
          right: "ich = «إش» بشين ناعمة حنكية",
          whyAr:
            "العربي يملك «خ» ولا يملك ich‑Laut، فيستبدل بالصوت المفقود أقربَ صوتٍ عنده. والقاعدة الحاسمة: ch تصير خاءً بعد a و o و u و au فقط؛ وفيما عدا ذلك هي شينٌ ناعمة. فـ Buch خاء لأنّ قبلها u، وich شين لأنّ قبلها i — والحرفان نفسهما!",
        },
        {
          wrong: "نطق Stadt كـ«ستات» و Sport كـ«سپورت»",
          right: "St- و Sp- في أوّل الكلمة = «شتات» و«شپورت»",
          whyAr:
            "قاعدةٌ يجهلها أغلب المبتدئين لأنّها لا تظهر في الكتابة إطلاقاً. والشرط دقيق: أوّل **الكلمة أو الجذع** فقط. لذلك verstehen = فرشتيهن (لأنّ steh- جذعٌ يبدأ بـ st) بينما Fenster = فنستر (لأنّ st في وسط الجذع لا أوّله).",
        },
        {
          wrong: "نطق Tag كـ«تاغ» و und كـ«أوند»",
          right: "الصامت المجهور يُهمَس آخر الكلمة: «تاك»، «أونت»",
          whyAr:
            "هذه قاعدة Auslautverhärtung، وهي منتظمة تماماً: b←p، d←t، g←k في نهاية الكلمة أو المقطع. ولا أثر لها في الكتابة، فتبقى Tag بحرف g. وأمارتها أنّها تزول عند إضافة نهاية: Tag = تاك، لكن Tage = تاغه، لأنّ g لم تعد في الآخر.",
        },
      ],
      relatedRuleComparison: {
        title: "طول حرف العلّة: القاعدة الخفيّة التي تكشفها الكتابة",
        content:
          "الألمانية تفرّق بين العلّة الطويلة والقصيرة تفريقاً يحمل معنى (Stadt «مدينة» ≠ Staat «دولة»، Ratte «جرذ» ≠ Rate «قسط»)، ولا تكتب حركاتٍ كالعربية. لكنّ الإملاء يترك لك **ثلاث إشارات موثوقة**: (١) علّةٌ متبوعة بـ h صامتة = طويلة (Uhr, gehen, ihn، فتُسمّى h المدّ Dehnungs‑h)؛ (٢) علّةٌ مضاعفة = طويلة (Boot, Tee, Saal)، و ie = i طويلة دائماً؛ (٣) علّةٌ متبوعة بصامتٍ **مضاعف** = قصيرة حتماً (Mutter, kommen, Wasser, Zucker حيث ck تعمل عمل kk). فتضعيف الصامت في الألمانية لا يُنطق مضعَّفاً كالشدّة العربية، بل هو **علامة على قصر العلّة قبله** ليس إلا. هذه أهمّ فكرة إملائية في اللغة كلّها، وستنفعك في كلّ كلمة تقرأها بعد اليوم.",
      },
    },
  ],
  ...
  reading: {
    ...
    glossary: [
      {
        ...
        ar: "مركز اللغات",
        noteAr:
          "كلمة مركّبة: Sprachen (لغات) + Zentrum (مركز). وجنس المركّب من جزئه الأخير: das Zentrum ⟵ das Sprachenzentrum.",
      },
      {
        de: "buchstabieren",
        ar: "يتهجّى",
        noteAr:
          "من der Buchstabe (الحرف). فعلٌ منتظم، وهو أهمّ فعل في هذا الدرس عملياً.",
      },
      {
        de: "das Formular",
        ar: "الاستمارة",
        noteAr:
          "كلمة ستقابلك في كلّ دائرة رسمية ألمانية. الجمع: die Formulare.",
      },
      {
        de: "wie schreibt man das?",
        ar: "كيف يُكتب هذا؟",
        noteAr:
          "man ضمير عامّ لا يُترجم («المرء/يُفعَل»)، ويأخذ الفعل معه صيغة الغائب المفرد: man schreibt.",
      },
      {
        de: "langsam",
        ar: "ببطء / بطيء",
        noteAr:
          "ضدّه schnell. وتُستعمل ظرفاً بلا أيّ نهاية: Sprechen Sie bitte langsam!",
      },
      {
        de: "freundlich",
        ar: "ودود / بلطف",
        noteAr:
          "من der Freund (الصديق) + النهاية ‑lich التي تصنع الصفات، كما في herzlich و täglich.",
      },
      {
        de: "die Telefonnummer",
        ar: "رقم الهاتف",
        noteAr:
          "مركّبة أيضاً، وجنسها من die Nummer. وتُقال أرقامها فرادى لا مجتمعة.",
      },
      {
        de: "der Raum",
        ar: "القاعة / الغرفة",
        noteAr:
          "الجمع بالإمالة: die Räume — مثالٌ حيّ على أنّ ä علامة جمع لا زخرفة.",
      },
      {
        de: "zum Schluss",
        ar: "في الختام / أخيراً",
      ...
      },
      {
        ...
        ar: "يبتسم",
        noteAr:
          "لاحظ ä فيه. ولا تخلطه بـ lachen (يضحك) — والفرق بينهما ch الغليظة وäch الرقيقة.",
      },
      {
        de: "kennen",
        ar: "يعرف (شخصاً أو مكاناً)",
        noteAr:
          "يخصّ المعرفة بالمعايشة. ويقابله wissen للمعرفة بالمعلومة — فرقٌ لا وجود له في العربية.",
      },
      {
        de: "Vielen Dank!",
        ar: "شكراً جزيلاً!",
        noteAr:
          "أدفأ من Danke المجرّدة. والردّ عليها: Bitte schön! أو Gern geschehen!",
      },
    ],
    questions: [
      {
        ...
        correctIndex: 1,
        explanation:
          "الجملة الأولى تنصّ: «Frau Weber arbeitet im Sprachenzentrum in Leipzig». وانتبه أنّ Leipzig مدينة العمل لا مكانه، فالسؤال بـ wo يطلب المكان الأدقّ المذكور.",
        optionExplanations: [
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation:
          "الألمان يتهجّون بأسماء علمٍ معيارية (Anton, Berta, Emil…) تماماً كما يقول الطيّارون Alpha‑Bravo. والغرض تفادي الخلط بين الحروف المتشابهة صوتياً في الهاتف، لا ذكر أشخاص بأعيانهم.",
        optionExplanations: [
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation:
          "النصّ يصرّح: «Sie schreiben das mit ß, nicht mit ss». والقاعدة تؤيّده: حرف a في Straße طويل، والعلّة الطويلة يليها ß لا ss. أمّا Goethe فتُكتب oe لأنّه اسم علم تاريخي حُفظ رسمه القديم.",
        optionExplanations: [
      ...
      },
      {
        ...
        correctIndex: 0,
        explanation:
          "النصّ: «Ihr Kurs beginnt am Montag um neun Uhr, Raum vier». والفخّ أنّ العدد أربعة وردَ فعلاً لكنّه رقم القاعة لا الساعة، والعدد اثنا عشر ورد لكنّه رقم البيت — فقراءة العدد وحده دون سياقه تُوقع في الخطأ.",
        optionExplanations: [
          undefined,
      ...
      },
      {
        ...
        options: ["nicht", "ich", "Buchstabe", "lächelt"],
        correctIndex: 2,
        explanation:
          "الخاء الغليظة تأتي بعد a و o و u و au. وفي Buchstabe يسبق ch حرف u فتُنطق خاءً. أمّا nicht وich فقبلهما i، وlächelt قبلها ä — وكلّها تُنطق شيناً ناعمة.",
        optionExplanations: [
    ...
    discussionAr:
      "تخيّل أنّك في مكتب التسجيل: تهجَّ اسمك الكامل بالألمانية مستعملاً جدول التهجّي (X wie …)، ثمّ اذكر شارعك ورقم هاتفك رقماً رقماً. سجّل نفسك بالهاتف واستمع: هل نطقتَ W ڤاءً؟ وهل جعلتَ ei آيَ؟ وهل همستَ آخر Tag؟ أعد المحاولة حتى تسلم الثلاثة.",
  },
  ...
  listening: {
    items: [
      {
        ...
        lines: [
          {
            speaker: "Sami",
            de: "Hallo, mein Name ist Sami Ben Ali.",
            ar: "مرحباً، اسمي سامي بن علي.",
          },
          {
            speaker: "Frau Weber",
            de: "Wie bitte? Können Sie das buchstabieren?",
            ar: "عذراً؟ هل يمكنك تهجئة ذلك؟",
          },
          {
            speaker: "Sami",
            de: "Ja, natürlich. S-A-M-I. B-E-N. A-L-I.",
            ar: "نعم بالطبع. إس-آ-إم-آي. بيه-إيه-إن. آ-إل-آي.",
          },
          {
            speaker: "Frau Weber",
            de: "Ah, vielen Dank, Herr Ben Ali!",
            ar: "آه، شكراً جزيلاً يا سيد بن علي!",
          },
        ],
      },
      {
        ...
        lines: [
          {
            speaker: "Lehrer",
            de: "Wie schreibt man „Schule“?",
            ar: "كيف تُكتب كلمة Schule (مدرسة)؟",
          },
          { speaker: "Mona", de: "S-C-H-U-L-E.", ar: "إس-تسيه-ها-وو-إل-إيه." },
          {
            speaker: "Lehrer",
            de: "Sehr gut! Und „Straße“?",
            ar: "ممتاز! وكلمة Straße (شارع)؟",
          },
          {
            speaker: "Mona",
            de: "S-T-R-A-ß-E.",
            ar: "إس-تيه-إر-آ-إسّتِت-إيه.",
          },
    ...
    questions: [
      ...
      },
      {
        ...
        correctIndex: 0,
        explanation:
          "School بالطبع S-C-H-U-L-E — لاحظ sch معاً ثم u ثم l ثم e.",
        errorType: "spelling",
      },
      {
        id: "q3",
  ...
  pronunciation: {
    ...
    items: [
      {
        de: "ich",
        ar: "أنا",
        note: "ch ناعمة بعد i: أقرب إلى «ش» هامسة من «خ»",
      },
    ...
    shadowing: [
      ...
      {
        de: "Ich buchstabiere: A-N-N-A.",
        ar: "أتهجّى: آ-إن-إن-آ.",
        tip: "حرف A في الألمانية = آ",
      },
      {
        de: "Die Schule ist in der Stadt.",
        ar: "المدرسة في المدينة.",
        tip: "Schule = شولِه، Stadt = شتات",
      },
      {
        de: "Das Buch ist neu.",
        ar: "الكتاب جديد.",
        tip: "Buch = بوخ (خ حلقية)",
      },
    ],
  },
  ...
  writing: [
    {
      ...
      prompt:
        "اكتب اسمك: S-A-M-I (مثال: أسماء عربية تُكتب حرفاً حرفاً كما تُنطق)",
      acceptedAnswers: ["S-A-M-I", "Sami", "S A M I"],
      sampleAnswer: "S-A-M-I (مثال: اكتب اسمك أنت بدلاً من ذلك)",
      explanation:
        "التهجئة بالألمانية: كل حرف يُنطق باسمه الألماني (A=آ، B=بيه، C=تسه...).",
      errorType: "spelling",
    },
    {
      id: "w2",
      ...
      explanation:
        "المرجع: mein (آي [aɪ]) / Wien (إي [iː]) / lieben (إي [iː]) / nein (آي [aɪ]). ie = إي طويلة · ei = آي مركّبة.",
      errorType: "spelling",
    },
    {
      id: "w3",
      ...
      explanation:
        "لاحظ: Schule (ش) + schön (ش+ö) + neu (أُوي). الجملة: Die Schule ist schön und neu.",
      errorType: "spelling",
    },
  ],
  ...
  practiceBank: [
    ...
    },
    {
      ...
      correctIndex: 1,
      explanation:
        "Vater = فاتر (ف). أما Video فتلفظ ڤ، وWasser وWien بـ ڤ أيضاً.",
      errorType: "spelling",
    },
    {
      id: "e3",
    ...
    },
    {
      ...
      explanation:
        "Mütter (أمهات) بـ ü، لكن Mutter (أم) بـ u. لاحظ أن المعنى تغيّر بالحرف المعلم!",
      errorType: "spelling",
    },
    {
      id: "e6",
      ...
      explanation:
        "بعد الأصوات الطويلة أو المركبة (a طويلة هنا) يُكتب ß وليس ss. Straße = شارع.",
      errorType: "spelling",
    },
    {
      id: "e7",
      ...
      correctIndex: 0,
      explanation:
        "pf يُنطق معاً: الشفتان تبدأ p ثم يمر الهواء f فوراً — آپفِل.",
      errorType: "spelling",
    },
    {
      id: "e8",
    ...
    },
    {
      ...
      type: "multiple-choice",
      instructionAr: "اختر النطق الصحيح:",
      questionDe: "Wie spricht man «Wasser»?",
      questionAr: "كيف تُنطق كلمة Wasser؟",
      options: [
        "ووسر (W إنجليزية)",
        "ڤاسّر (W = ڤ)",
        "فاسّر (W = ف)",
      ...
      correctIndex: 1,
      explanation:
        "حرف W الألماني يُنطق «ڤ» دائماً. وss هنا مهموسة «س» حادّة لأنّها مضاعفة، وهي تدلّ في الوقت نفسه على أنّ a قبلها قصيرة.",
      optionExplanations: [
        "هذه قيمة W الإنجليزية لا الألمانية.",
        undefined,
        "«ف» قيمة V لا W.",
        "ss المضاعفة مهموسة دائماً، فلا تُنطق «ز».",
      ],
      errorType: "spelling",
    },
    {
      id: "e12",
      type: "multiple-choice",
      instructionAr: "أيّ كلمة تُنطق فيها ch خاءً غليظة؟",
      questionDe: "Wo hört man den ach-Laut?",
      questionAr: "أين تُسمع الخاء الغليظة؟",
      options: ["die Milch", "das Buch", "nicht", "die Kirche"],
      correctIndex: 1,
      explanation:
        "الخاء الغليظة (ach-Laut) تأتي حصراً بعد a و o و u و au. وفي Buch يسبقها u. أمّا Milch فقبلها l، وnicht قبلها i، وKirche قبلها r — وكلّها شين ناعمة.",
      optionExplanations: [
        "بعد الصامت l تكون شيناً ناعمة.",
        undefined,
        "بعد i تكون شيناً ناعمة.",
        "بعد r تكون شيناً ناعمة.",
      ],
      errorType: "spelling",
    },
    {
      id: "e13",
      type: "fill-blank",
      instructionAr: "أكمل بالإملاء الصحيح (ß أم ss؟):",
      template: "Ich wohne in der Bahnhofstra___e.",
      blanks: [{ correct: "ß", options: ["ß", "ss", "s", "sz"] }],
      explanation:
        "حرف a في Straße طويل، والعلّة الطويلة يليها ß لا ss. ولو كانت العلّة قصيرة لكُتبت ss كما في Wasser وmuss.",
      errorType: "spelling",
    },
    {
      id: "e14",
      ...
      wrongSentence: "Meine Mutter hat zwei Mutter im Haus.",
      wrongWord: "Mutter",
      correctWord: "Mütter",
      options: ["Mütter", "Muttern", "Mutters", "Muter"],
      explanation:
        "جمع Mutter هو Mütter بالإمالة وحدها بلا أيّ نهاية. فالإمالة هنا ليست تفصيلاً صوتياً بل هي علامة الجمع الوحيدة — ومَن أهملها لم يفرّق بين الأمّ والأمّهات.",
      errorType: "plural",
    },
    {
      id: "e15",
      type: "matching",
      instructionAr: "طابق كلّ مجموعة حروف بنطقها:",
      pairs: [
        { left: "ei", right: "آي (mein)" },
        { left: "ie", right: "إي ممدودة (Liebe)" },
        { left: "eu", right: "أُويْ (neu)" },
        { left: "sch", right: "ش صافية (Schule)" },
        { left: "tz", right: "تس (Katze)" },
        { left: "pf", right: "پف (Apfel)" },
      ],
      explanation:
        "هذه المجموعات الستّ تغطّي أغلب ما يقرؤه المبتدئ. وأخطرها زوج ei/ie لأنّهما مقلوبان شكلاً وصوتاً معاً.",
      errorType: "spelling",
    },
  ],
  ...
  fehlerUndTipps: {
    mistakes: [
      {
        wrong: "نطق W الإنجليزية (Water = ووتر)",
        right: "نطق W كـ ڤ (Wasser = ڤاسّر)",
        whyAr:
          "الألمانية لا تملك w الإنجليزي إطلاقاً — ووه تعني «أين» وتُنطق ڤوه!",
      },
      {
        wrong: "نطق ei كـ«إي»",
        right: "نطق ei كـ«آي» (mein = ماين)",
        whyAr:
          "احفظ: nein (لا) = ناين، zwei (اثنان) = تسڤاي، drei (ثلاثة) = دراي.",
      },
      {
        wrong: "كتابة ss بدل ß في Straße",
        right: "Straße (بـ ß)",
        whyAr:
          "بعد حرف علة طويل أو مركب يأتي ß، بعد حرف قصير يأتي ss (das Schloss = القفل).",
      },
    ],
    eselsbruecken: [
  ...
  miniTest: [
    ...
    },
    {
      ...
      explanation:
        "nein=آي [aɪ]، diese=إي [iː]، wie=إي [iː]، kein=آي [aɪ]. ie تُقرأ إي (طويلة) و ei تُقرأ آي (مركّبة).",
      errorType: "spelling",
    },
    {
      id: "m5",
      ...
      explanation:
        "Buchstabe (حرف) صحيحة كما هي! هذا تمرين ثقة: أحياناً الإجابة الصحيحة هي الأصل نفسه. أتقنت الأبجدية! 🎉",
      errorType: "spelling",
    },
  ],
  ...
  flashcards: [
    {
      ...
      de: "das Alphabet",
      ar: "الأبجدية",
      example: "Das Alphabet hat 26 Buchstaben.",
      exampleAr: "الأبجدية فيها 26 حرفاً.",
      level: "A1",
    },
    {
      id: "fc2",
    ...
    },
    {
      ...
      de: "aussprechen",
      ar: "ينطق",
      example: "Wie spricht man das aus?",
      exampleAr: "كيف يُنطق هذا؟",
      level: "A1",
    },
    {
      id: "fc4",
    ...
    },
    {
      ...
      exampleAr: "املأ الاستمارة من فضلك.",
      level: "A1",
    },
    {
      id: "fc10",
      de: "Wie schreibt man das?",
      ar: "كيف يُكتب هذا؟",
      example: "Chaabane? Wie schreibt man das?",
      exampleAr: "شعبان؟ كيف يُكتب هذا؟",
      level: "A1",
    },
    {
      id: "fc11",
    ...
    },
    {
      ...
      de: "ch بعد a-o-u = خاء",
      ar: "Buch, auch, Nacht",
      example: "Das Buch ist auch neu.",
      exampleAr: "الكتاب جديد أيضاً.",
      level: "A1",
    },
    {
      id: "fc13",
      de: "ch بعد i-e-ä = شين ناعمة",
      ar: "ich, nicht, Milch",
      example: "Ich spreche nicht viel.",
      exampleAr: "لا أتكلّم كثيراً.",
      level: "A1",
    },
    {
      id: "fc14",
      de: "St- / Sp- في أوّل الكلمة = شت / شپ",
      ar: "Stadt = شتات، Sport = شپورت",
      example: "Die Stadt ist schön.",
      exampleAr: "المدينة جميلة.",
      level: "A1",
    },
    {
      id: "fc15",
      de: "der Student",
      ar: "الطالب الجامعيّ",
      example: "Ich bin Student aus Tunesien.",
      exampleAr: "أنا طالب من تونس.",
      level: "A1",
    },
    {
      id: "fc16",
      de: "der Stift",
      ar: "القلم",
      example: "Haben Sie einen Stift?",
      exampleAr: "هل معك قلم؟",
      level: "A1",
    },
    {
      id: "fc17",
      de: "fragen",
      ar: "يسأل",
      example: "Die Lehrerin fragt: Wie heißen Sie?",
      exampleAr: "تسأل المعلّمة: ما اسمك؟",
      level: "A1",
    },
    {
      id: "fc18",
      de: "antworten",
      ar: "يجيب",
      example: "Ich antworte auf Deutsch.",
      exampleAr: "أجيب بالألمانية.",
      level: "A1",
    },
    {
      id: "fc19",
      de: "Auf Wiedersehen!",
      ar: "إلى اللقاء! (وداعٌ رسميّ)",
      example: "Auf Wiedersehen, Frau Weber!",
      exampleAr: "إلى اللقاء سيدة فيبر!",
      level: "A1",
    },
  ],
  ...
  review: [
    {
      ...
      type: "multiple-choice",
      instructionAr:
        "مراجعة تمهيدية (قبل A1 — لا درس سابق): ما هي اللغة التي تتعلمها في هذه المنصة؟",
    ...
    },
    {
      ...
      type: "multiple-choice",
      instructionAr:
        "مراجعة تمهيدية (قبل A1 — لا درس سابق): كم حرفاً في الأبجدية الألمانية؟",
  ...
  mediation: [
    {
      ...
      sourceDe:
        "Das deutsche Alphabet hat 26 Buchstaben. Dazu kommen ä, ö, ü und ß. Manche Buchstaben hören sich anders an als im Arabischen.",
      taskAr:
        "انقل بالعربية أهم ثلاث معلومات عن الأبجدية الألمانية لصديق مبتدئ: عدد الحروف، الحروف الإضافية، والاختلاف عن العربية.",
      modelAnswerAr:
        "«الأبجدية الألمانية فيها 26 حرفاً، بالإضافة إلى ä وö وü وß. بعض الحروف تُنطق بشكل مختلف عن العربية.»",
      keyPointsAr: [
        "ذكرت عدد الحروف (26)",
        "ذكرت الحروف الإضافية الأربعة",
        "أشرت إلى اختلاف النطق عن العربية",
      ],
    },
  ],
  interaction: [
    {
      ...
      scenarioDe:
        "Ein Freund fragt dich nach der Aussprache eines Buchstabens.",
      ...
      rounds: [
        {
          ...
          options: [
            {
              de: "Nach a, o, u wie ein „ch“ aus dem Hals. Nach e, i wie ein weiches „sch“.",
              ar: "بعد a, o, u من الحلق. وبعد e, i مثل «ش» ناعمة.",
              best: true,
              replyDe: "Ach so! Und „sch“?",
              replyAr: "فهمت! و«sch»؟",
            },
            {
              de: "Immer wie ein „k“.",
              ar: "دائماً مثل «ك».",
              best: false,
              replyDe: "Nein, das ist leider falsch. Es hängt vom Vokal ab.",
              replyAr: "لا، هذا خطأ للأسف. يعتمد على العلة.",
            },
          ],
        },
        {
          ...
          options: [
            {
              de: "Wie ein „sch“ auf Arabisch: Schule, schön.",
              ar: "مثل «ش» العربية: Schule, schön.",
              best: true,
              replyDe: "Danke! Das ist einfach.",
              replyAr: "شكراً! هذا سهل.",
            },
            {
              de: "Wie ein „s“.",
              ar: "مثل «س».",
              best: false,
              replyDe: "Nein, „sch“ ist wie das arabische schin.",
              replyAr: "لا، «sch» مثل الشين العربية.",
            },
          ],
        },
      ],
