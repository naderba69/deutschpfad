...
export const lessonA109: Lesson = {
  ...
  lernziele: [
    {
      id: "z1",
      de: "Ich kann die Wochentage und Monate nennen.",
      ar: "أن أسمّي أيام الأسبوع والشهور بالترتيب.",
    },
    {
      id: "z2",
      de: "Ich kann die Jahreszeiten sagen.",
      ar: "أن أسمّي الفصول الأربعة.",
    },
    {
      id: "z3",
      de: "Ich kann Ordinalzahlen bilden: der erste, der zweite...",
      ar: "أن أصيغ الأعداد الترتيبية (الأول، الثاني...).",
    },
    {
      id: "z4",
      de: "Ich kann Termine machen: Am Montag um neun Uhr.",
      ar: "أن أحدد المواعيد: يوم الاثنين في التاسعة.",
    },
  ],
  einfuehrung: {
    ...
    connectionToPreviousAr:
      "تعلمنا الساعة (halb acht...) في درس الروتين. اليوم نضيف الأيام والأشهر — ودمجهما معاً يعطينا «الموعد الكامل».",
    activateVocabulary: [
  ...
  theory: [
    {
      ...
      table: {
        ...
        rows: [
          ...
          {
            label: "الفصول",
            cells: ["Frühling/Sommer/Herbst/Winter", "ربيع/صيف/خريف/شتاء"],
          },
        ],
      },
      examples: [
        ...
        {
          de: "Der Termin ist am Freitag um drei Uhr.",
          ar: "الموعد يوم الجمعة في الثالثة.",
        },
        {
          de: "Montags habe ich immer Deutschkurs.",
          ar: "كلّ اثنين عندي درس ألمانية. (عادة ⇐ حرف صغير + s)",
        },
        {
          de: "In Norddeutschland sagt man Sonnabend statt Samstag.",
          ar: "في شمال ألمانيا يقولون Sonnabend بدل Samstag.",
        },
        {
          de: "Der Sommer ist meine Lieblingsjahreszeit.",
          ar: "الصيف فصلي المفضّل. (der Sommer مذكّر)",
        },
      ],
      ...
      commonMistakes: [
        {
          wrong: "Tag Freitag habe ich frei.",
          right: "Am Freitag habe ich frei.",
          whyAr:
            "ترجمة حرفية لـ„يوم الجمعة“. واسم اليوم الألمانيّ يحمل Tag في آخره أصلاً، فإضافة كلمة Tag تكرارٌ ركيك. والحرف الصحيح am لا غير.",
        },
        {
          wrong: "Die Montag ist schwer.",
          right: "Der Montag ist schwer.",
          whyAr:
            "كلّ أيام الأسبوع مذكّرة لأنّ جزأها الأخير der Tag مذكّر، والكلمة المركّبة الألمانية تأخذ جنس جزئها الأخير دائماً. وهذه قاعدة تنفعك في آلاف المركّبات لا في الأيام وحدها.",
        },
        {
          wrong: "Ich arbeite Montags.",
          right: "Ich arbeite montags.",
          whyAr:
            "حين يتحوّل اليوم إلى ظرف تكرار يفقد صفة الاسم فيُكتب بحرفٍ صغير: montags. والحرف الكبير يعني اليوم المعيَّن، والصغير يعني العادة المتكرّرة.",
        },
        {
          wrong: "Im Montag habe ich Zeit.",
          right: "Am Montag habe ich Zeit.",
          whyAr:
            "im للشهور والفصول، وam للأيام والتواريخ. والخطأ يأتي من أنّ العربية تستعمل „في“ للاثنين ولمايو معاً، فينقل المتعلّم حرفاً واحداً إلى موضعين مختلفين.",
        },
      ],
      relatedRuleComparison: {
        title: "am أم im؟",
        content:
          "am + يوم/تاريخ: am Montag, am 5. Mai. im + شهر/فصل/سنة: im Mai, im Sommer, im Jahr 2025.",
      },
    },
    {
      id: "t2",
      ...
      examples: [
        ...
        {
          de: "Der Termin ist am dritten Juli.",
          ar: "الموعد في الثالث من يوليو. (am ⇐ ـen)",
        },
        { de: "Das ist mein zweiter Besuch.", ar: "هذه زيارتي الثانية." },
        { de: "Sie wohnt im vierten Stock.", ar: "هي تسكن في الطابق الرابع." },
        {
          de: "Wir treffen uns am zwanzigsten November.",
          ar: "نلتقي في العشرين من نوفمبر. (20 ⇐ ste)",
        },
        {
          de: "Der siebte Tag heißt Sonntag.",
          ar: "اليوم السابع اسمه الأحد. (شاذّ: siebte)",
        },
        {
          de: "Ich nehme den ersten Termin.",
          ar: "آخذ الموعد الأوّل. (نصب ⇐ den ersten)",
        },
        {
          de: "Der Kurs beginnt am achten Januar.",
          ar: "الدورة تبدأ في الثامن من يناير.",
        },
      ],
      comparisonWithArabic:
      ...
      commonMistakes: [
        {
          wrong: "der dreite Mai",
          right: "der dritte Mai",
          whyAr:
            "drei تفقد حرف e عند صياغة الترتيبيّ فتصير dritte لا dreite. وهو أوّل الشواذّ الثلاثة وأكثرها وروداً لأنّه يقع في كلّ شهر مرّة.",
        },
        {
          wrong: "am zwanzigte Mai",
          right: "am zwanzigsten Mai",
          whyAr:
            "خطآن في كلمة: العشرون فما فوق يأخذ ste لا te، وبعد am تُضاف النهاية en. فالصواب zwanzig + ste + n. وتفكيك الكلمة إلى أجزائها الثلاثة يمنع الخطأ.",
        },
        {
          wrong: "Heute ist am fünften Mai.",
          right: "Heute ist der fünfte Mai.",
          whyAr:
            "«اليوم هو…» جملة خبرية بالرفع فلا حرف جرّ فيها. وam موضعها جواب سؤال wann? لا جواب سؤال der wievielte?. والخلط بينهما أشيع أخطاء التاريخ.",
        },
        {
          wrong: "Ich habe am 3 Mai einen Termin.",
          right: "Ich habe am 3. Mai einen Termin.",
          whyAr:
            "النقطة بعد الرقم هي التي تجعله ترتيبياً. وبدونها تُقرأ الجملة «في ثلاثة مايو» وهي بلا معنى. النقطة إذاً حرفٌ لا علامة ترقيم.",
        },
      ],
      relatedRuleComparison: {
        title: "الترتيبي مع النصب",
        content:
          "مثل الصفات، الترتيبي يتصرف مع الاسم: Ich habe den ersten Termin (نصب: den ersten). هذه مقدمة لتصريف الصفات الكامل في B1.",
      },
    },
    {
      id: "t3",
      ...
      table: {
        ...
        rows: [
          {
            label: "ما تاريخ اليوم؟",
            cells: ["der + ـte/ـste", "Heute ist der erste März."],
          },
          {
            label: "متى الموعد؟",
            cells: ["am + ـten/ـsten", "Der Termin ist am ersten März."],
          },
          {
            label: "من … إلى …",
            cells: ["vom … bis zum …", "vom 1. bis zum 15. Juni"],
          },
          {
            label: "سنة الميلاد",
            cells: ["بلا حرف جر", "Ich bin 1995 geboren."],
          },
        ],
      },
      examples: [
        {
          de: "Der wievielte ist heute? — Heute ist der siebte April.",
          ar: "ما تاريخ اليوم؟ — اليوم السابع من أبريل.",
        },
        {
          de: "Mein Geburtstag ist am zwölften Oktober.",
          ar: "عيد ميلادي في الثاني عشر من أكتوبر.",
        },
        {
          de: "Der Kurs geht vom ersten bis zum dritten Mai.",
          ar: "الدورة من الأوّل إلى الثالث من مايو.",
        },
        {
          de: "Ich habe am 3. Januar einen Termin beim Arzt.",
          ar: "لديّ موعد عند الطبيب في الثالث من يناير.",
        },
        { de: "Sie ist 1998 geboren.", ar: "وُلدت عام 1998. (بلا حرف جرّ)" },
        {
          de: "Vom fünften bis zum zehnten August habe ich Urlaub.",
          ar: "من الخامس إلى العاشر من أغسطس عندي إجازة.",
        },
        {
          de: "Der wievielte ist morgen? — Morgen ist der neunte.",
          ar: "ما تاريخ الغد؟ — غداً التاسع.",
        },
      ],
      comparisonWithArabic:
      ...
      commonMistakes: [
        {
          ...
          whyAr:
            "بعد am تأخذ الصفة الترتيبية النهاية ـen دائماً. القاعدة صارمة بلا استثناء هنا، لأنّ am اختصار an + dem وهو جرٌّ يفرض نهايته على الصفة.",
        },
        {
          wrong: "Heute ist am fünften Mai.",
          right: "Heute ist der fünfte Mai.",
          whyAr:
            "«اليوم هو…» جملة خبرية بالرفع، فلا حرف جرّ فيها: der fünfte. أمّا am فلتحديد موعد جواباً لسؤال wann?. والخلط بين السؤالين أشيع أخطاء التاريخ عند المبتدئين.",
        },
        {
          wrong: "Ich bin im 1995 geboren.",
          right: "Ich bin 1995 geboren.",
          whyAr:
            "سنة الميلاد تُقال عاريةً بلا حرف جرّ، أو بالصيغة الكاملة im Jahr 1995. أمّا im 1995 فخليطٌ بين الصيغتين لا تقوله الألمانية، وهو من أشيع أخطاء الاستمارات الرسمية.",
        },
        {
          wrong: "vom ersten bis dritten Mai",
          right: "vom ersten bis zum dritten Mai",
          whyAr:
            "التركيب مزدوج ومتلازم: vom … bis zum. وحذف zum يترك bis بلا أداة فتصير العبارة ناقصة. احفظهما وحدةً واحدة لا حرفين منفصلين.",
        },
      ],
      relatedRuleComparison: {
    ...
    },
    {
      ...
      table: {
        ...
        rows: [
          {
            label: "von … bis …",
            cells: ["من … إلى … (مدى مغلق)", "Von neun bis zwölf."],
          },
          {
            label: "ab",
            cells: ["ابتداءً من (مدى مفتوح)", "Ab Montag habe ich Zeit."],
          },
          {
            label: "bis",
            cells: ["حتّى (نهاية فقط)", "Ich arbeite bis sechs."],
          },
          { label: "gegen", cells: ["نحو، تقريباً", "Ich komme gegen drei."] },
          {
            label: "zwischen … und …",
            cells: ["بين … و…", "Zwischen zwei und vier."],
          },
        ],
      },
      examples: [
        {
          ...
          ar: "نهارك سعيد، أودّ موعداً.",
        },
        {
          de: "Die Praxis ist von acht bis achtzehn Uhr geöffnet.",
          ar: "العيادة مفتوحة من الثامنة إلى السادسة مساءً.",
        },
        {
          de: "Ab Montag habe ich wieder Zeit.",
          ar: "ابتداءً من الاثنين أصير متفرّغاً من جديد.",
        },
        {
        ...
        {
          de: "Geht es auch am Mittwoch um zehn?",
          ar: "هل يمكن الأربعاء في العاشرة أيضاً؟",
        },
      ...
      commonMistakes: [
        {
          ...
          whyAr:
            "von لا تقف وحدها في المدى المفتوح، بل تنتظر bis لتُغلقه. والمدى المفتوح — ما بعد يومٍ ما إلى غير نهاية — حرفه ab وحده. ومصدر الخطأ أنّ العربية تؤدّي المعنيين بـ„من“ نفسها.",
        },
        {
          wrong: "Ich will einen Termin.",
          right: "Ich hätte gern einen Termin.",
          whyAr:
            "wollen تصريحٌ بالإرادة يُسمع في العيادة فظّاً كأنّك تأمر. وhätte gern صيغة مجاملة ثابتة يستعملها الألمان في كلّ طلب. وليست ترفاً: نبرتها هي التي تفتح لك الباب.",
        },
        {
          wrong: "Es tut mir leid, dort kann ich nicht.",
          right: "Es tut mir leid, da kann ich nicht.",
          whyAr:
            "dort ظرف مكان (هناك) بينما da هنا ظرف زمان يحيل على الموعد المذكور. وترجمة „هناك“ حرفياً تُنتج جملةً يفهم منها المخاطب أنّك تتكلّم عن مكان العيادة لا عن ساعتها.",
        },
        {
          wrong: "Ich komme um circa drei Uhr.",
          right: "Ich komme gegen drei Uhr.",
          whyAr:
            "um تعني الدقّة، وcirca تعني التقريب، فاجتماعهما تناقض. والألمانية أعدّت لهذا حرفاً واحداً هو gegen يحمل التقريب في ذاته دون حاجة إلى كلمة إضافية.",
        },
      ],
      relatedRuleComparison: {
  ...
  reading: {
    ...
    questions: [
      {
        ...
        paragraph: 0,
        explanation:
          "الفقرة الأولى تقول Nadia hat Zahnschmerzen — ولهذا تتّصل بالعيادة.",
      },
      {
        id: "rq2",
        type: "multiple-choice",
        ...
        paragraph: 2,
        explanation:
          "السكرتيرة تقول Wir sind von acht bis achtzehn Uhr für Sie da — مدى مغلق بحرفَي von … bis.",
      },
      {
        id: "rq3",
        type: "multiple-choice",
        ...
        paragraph: 3,
        explanation:
          "تقول Um zehn kommt der Techniker zu mir nach Hause — فترفض الموعد بـ es tut mir leid, da kann ich nicht.",
      },
      {
        id: "rq4",
        type: "multiple-choice",
        ...
        paragraph: 4,
        explanation:
          "الاتّفاق النهائيّ: der neunte April um vierzehn Uhr — والتاريخ ترتيبيّ بالنقطة 9.",
      },
      {
        id: "rq5",
        type: "multiple-choice",
        ...
        paragraph: 5,
        explanation:
          "الجواب في الفقرة الأخيرة: Dann rufen Sie bitte einen Tag vorher an — الاتّصال قبل الموعد بيوم.",
      },
    ],
    redemittel: [
      {
    ...
    discussionAr:
      "احكِ عن آخر موعدٍ حجزته: متى كان ومع من؟ وهل حدث أن اضطررت إلى تأجيله أو إلغائه؟ اكتب الحوار بالألمانية مستعملاً von … bis وab وgegen وثلاث عبارات من قائمة Redemittel أعلاه.",
  },
        ...
        lines: [
          {
            ...
            de: "Guten Tag, Praxis Dr. Weber.",
            ar: "نهارك سعيد، عيادة الدكتور فيبر.",
          },
          {
            speaker: "Sami",
            de: "Guten Tag, ich möchte einen Termin.",
            ar: "نهارك سعيد، أريد موعداً.",
          },
          {
            speaker: "Sprechstundenhilfe",
          ...
          {
            speaker: "Sami",
            de: "Am Montag oder am Dienstag, bitte.",
            ar: "يوم الاثنين أو الثلاثاء من فضلك.",
          },
          {
            speaker: "Sprechstundenhilfe",
            de: "Am Montag um neun Uhr?",
            ar: "الاثنين في التاسعة؟",
          },
          {
            speaker: "Sami",
            de: "Perfekt! Um neun Uhr am Montag.",
            ar: "ممتاز! التاسعة يوم الاثنين.",
          },
        ],
      },
      {
        ...
        lines: [
          ...
          {
            speaker: "Karim",
            de: "Am dritten August. Und du?",
            ar: "في الثالث من أغسطس. وأنتِ؟",
          },
          {
            speaker: "Anna",
            de: "Am fünfzehnten Dezember.",
            ar: "في الخامس عشر من ديسمبر.",
          },
          {
            speaker: "Karim",
            de: "Im Winter! Schöne Zeit.",
            ar: "في الشتاء! وقت جميل.",
          },
        ],
      },
    ],
    ...
    items: [
      {
        de: "Montag",
        ar: "الاثنين",
        note: "g في النهاية = ك قاطعة (تقسية الأواخر)، وo طويلة: موون-تااك",
      },
      ...
      { de: "Donnerstag", ar: "الخميس", note: "rr مزدوجة: دونّر-شتاخ" },
      {
        de: "der Frühling",
        ar: "الربيع",
        note: "ü طويلة + ng = نون غُنّة واحدة (لا g منفصلة ولا خ): فريو-لينغ",
      },
      { de: "der Monat", ar: "الشهر", note: "o مفتوح: مو-نات" },
      {
        de: "der Herbst",
        ar: "الخريف",
        note: "h + r: هيربست (b لا تُنطق تقريباً)",
      },
    ],
    ...
    shadowing: [
      {
        de: "Heute ist Montag.",
        ar: "اليوم الاثنين.",
        tip: "Montag = مون-تاخ (g→خ)",
      },
      {
        de: "Am Samstag gehe ich einkaufen.",
        ar: "السبت أذهب للتسوق.",
        tip: "Samstag = زامس-تاخ",
      },
      {
        de: "Mein Geburtstag ist im Mai.",
        ar: "عيد ميلادي في مايو.",
        tip: "Geburtstag = غيبورتس-تاخ",
      },
      {
        de: "Der Termin ist am dritten Juli.",
        ar: "الموعد في الثالث من يوليو.",
        tip: "dritten = دريتِن (tr معاً)",
      },
    ],
  },
  writing: [
    {
      ...
      explanation:
        "الموعد الكامل: am + يوم + um + ساعة: Am Montag um zehn Uhr.",
      errorType: "grammar",
    },
    {
      id: "w2",
    ...
    },
    {
      ...
      explanation:
        "عيد ميلادي في العاشر من مارس — am zehnten (ترتيبي + نهاية نصب).",
      errorType: "spelling",
    },
  ],
  practiceBank: [
    ...
    },
    {
      ...
      template:
        "Januar, Februar, ___, April, Mai, ___, Juli, August, September, ___, November, Dezember",
      blanks: [
    ...
    },
    {
      ...
      explanation:
        "«اليوم هو…» رفعٌ بلا حرف جرّ ⇒ der zweite. وتحديد الموعد بحرف الجر ⇒ am zweiten.",
      errorType: "preposition",
    },
    {
      id: "e12",
    ...
    },
    {
      ...
      correctIndex: 0,
      explanation:
        "الألمان يكتبون اليوم أوّلاً ثم الشهر: 5.9. = الخامس من الشهر التاسع (سبتمبر).",
      optionExplanations: [
        undefined,
    ...
    },
    {
      ...
      explanation:
        "السؤال المعتاد عن التاريخ: Der wievielte ist heute? ويُجاب: Heute ist der …",
      errorType: "word-order",
    },
    {
      id: "e15",
      ...
      prompt:
        "Heute ist der zehnte Mai. → قل إنّ لديك موعداً في ذلك اليوم (ابدأ بـ Ich habe).",
      acceptedAnswers: [
      ...
      explanation:
        "الانتقال من der zehnte (رفع) إلى am zehnten (بعد حرف الجر) هو جوهر التمرين.",
      errorType: "case",
    },
    {
      id: "e16",
      type: "multiple-choice",
      instructionAr: "اختر الحرف الصحيح للمدى الزمنيّ:",
      questionDe: "Die Praxis ist ___ acht ___ achtzehn Uhr geöffnet.",
      options: ["von … bis", "ab … bis", "in … zu", "um … bis"],
      correctIndex: 0,
      errorType: "preposition",
      explanation:
        "المدى المغلق تركيبه ثابت: von … bis …. وab لا تُستعمل مع bis لأنّها للمدى المفتوح.",
    },
    {
      id: "e17",
      type: "multiple-choice",
      instructionAr: "أيّ جملة تعني أنّ الإجازة تبدأ الاثنين وتستمرّ؟",
      questionDe:
        "Welcher Satz bedeutet: Der Urlaub beginnt am Montag und geht weiter?",
      options: [
        "Ab Montag habe ich Urlaub.",
        "Bis Montag habe ich Urlaub.",
        "Am Montag habe ich Urlaub.",
        "Von Montag habe ich Urlaub.",
      ],
      correctIndex: 0,
      errorType: "preposition",
      explanation:
        "ab تفتح المدى ولا تغلقه. وbis Montag تعني أنّ الإجازة تنتهي الاثنين — معنى معاكس تماماً.",
    },
    {
      id: "e18",
      type: "fill-blank",
      instructionAr: "أكمل بالعدد الترتيبيّ في صيغته الصحيحة:",
      errorType: "grammar",
      template:
        "Mein Geburtstag ist am ___ Mai, und heute ist ___ zwanzigste Mai.",
      blanks: [
        {
          correct: "dritten",
          options: ["dritten", "dritte", "dreite", "dritter"],
          errorType: "grammar",
        },
        {
          correct: "der",
          options: ["der", "am", "den", "im"],
          errorType: "article",
        },
      ],
      explanation:
        "بعد am تأتي النهاية ـen (dritten)، وفي الجملة الخبرية بالرفع تأتي الأداة der مع النهاية ـe.",
    },
    {
      id: "e19",
      type: "error-correction",
      instructionAr: "صحّح الخطأ في الجملة:",
      wrongSentence: "Ich komme um circa drei Uhr.",
      wrongWord: "um circa",
      correctWord: "gegen",
      options: ["gegen", "ab", "von", "bis"],
      errorType: "preposition",
      explanation:
        "um تعني الدقّة وcirca تعني التقريب، فاجتماعهما تناقض. وgegen وحدها تحمل معنى التقريب.",
    },
    {
      id: "e20",
      type: "error-correction",
      instructionAr: "صحّح الخطأ في الجملة:",
      wrongSentence: "Es tut mir leid, dort kann ich nicht.",
      wrongWord: "dort",
      correctWord: "da",
      options: ["da", "dann", "dort", "hier"],
      errorType: "vocabulary",
      explanation:
        "da هنا ظرف زمان يحيل على الموعد المذكور، أمّا dort فظرف مكان. والفرق بينهما يقلب معنى الاعتذار.",
    },
    {
      id: "e21",
      type: "word-ordering",
      instructionAr: "رتّب الكلمات لتكوّن طلب موعد مهذّباً:",
      tokens: ["Ich", "hätte", "gern", "einen", "Termin", "am", "Donnerstag"],
      correctSentence: "Ich hätte gern einen Termin am Donnerstag.",
      errorType: "word-order",
      explanation:
        "صيغة الطلب المهذّبة ثابتة: Ich hätte gern + المفعول به، ثمّ التحديد الزمنيّ في آخر الجملة.",
    },
    {
      id: "e22",
      type: "matching",
      instructionAr: "صِل كلّ حرف بمعناه الزمنيّ:",
      pairs: [
        { left: "von … bis …", right: "مدى مغلق: من … إلى …" },
        { left: "ab", right: "مدى مفتوح: ابتداءً من" },
        { left: "gegen", right: "تقريب: نحو الساعة" },
        { left: "montags", right: "تكرار: كلّ اثنين" },
        { left: "vom … bis zum …", right: "بين تاريخين" },
      ],
      errorType: "preposition",
      explanation:
        "أربعة حروف وظرف تكرار واحد يغطّون كلّ ما تحتاجه لترتيب موعد بالألمانية.",
    },
    {
      id: "e23",
      type: "transformation",
      instructionAr: "حوّل الجملة من تحديد يومٍ معيّن إلى عادة متكرّرة:",
      prompt: "Am Montag habe ich Deutschkurs. ⇐ (كلّ اثنين)",
      acceptedAnswers: [
        "Montags habe ich Deutschkurs.",
        "montags habe ich Deutschkurs.",
      ],
      sampleAnswer: "Montags habe ich Deutschkurs.",
      errorType: "word-order",
      explanation:
        "ظرف التكرار يُصاغ بإضافة s إلى اسم اليوم وبحرفٍ صغير: montags. ويبقى الفعل في المركز الثاني.",
    },
    {
      id: "e24",
      type: "multiple-choice",
      instructionAr: "اختر الصيغة الصحيحة لسنة الميلاد:",
      questionDe: "Ich bin ___ geboren.",
      options: ["1995", "im 1995", "am 1995", "in 1995"],
      correctIndex: 0,
      errorType: "preposition",
      explanation:
        "سنة الميلاد تُقال عاريةً بلا حرف جرّ، أو بالصيغة الكاملة im Jahr 1995. أمّا im 1995 فخليط خاطئ.",
    },
    {
      id: "e25",
      type: "fill-blank",
      instructionAr: "أكمل تركيب المدى بين تاريخين:",
      errorType: "preposition",
      template: "Der Kurs geht ___ ersten ___ zum zehnten Juli.",
      blanks: [
        {
          correct: "vom",
          options: ["vom", "von", "ab", "am"],
          errorType: "preposition",
        },
        {
          correct: "bis",
          options: ["bis", "und", "zu", "auf"],
          errorType: "preposition",
        },
      ],
      explanation:
        "التركيب متلازم: vom … bis zum …. من قال vom لزمه bis zum، ولا يجوز حذف zum.",
    },
    {
      id: "e26",
      type: "error-correction",
      instructionAr: "صحّح صيغة الطلب في العيادة:",
      wrongSentence: "Guten Tag, ich will einen Termin.",
      wrongWord: "will",
      correctWord: "hätte",
      options: ["hätte", "muss", "kann", "soll"],
      errorType: "vocabulary",
      explanation:
        "Ich will يُسمع أمراً فظّاً في العيادة. والصيغة المعيارية المهذّبة: Ich hätte gern einen Termin.",
    },
  ],
  fehlerUndTipps: {
    mistakes: [
      {
        wrong: "In Montag / In Januar",
        right: "Am Montag / Im Januar",
        whyAr: "am + أيام، im + أشهر.",
      },
      {
        wrong: "der dritete (تطبيق القاعدة على شاذ)",
        right: "der dritte",
        whyAr: "dritte شاذ جاهز — مثل «ثالث» في العربية.",
      },
      {
        wrong: "Mittwoch تعني «الأربعاء» لكن بعضهم يقول الوسط",
        right: "Mittwoch = الأربعاء حرفياً «منتصف الأسبوع»",
        whyAr: "لا ترتبك: هي يوم الأربعاء فعلاً.",
      },
    ],
    eselsbruecken: [
  ...
  flashcards: [
    {
      ...
      exampleAr: "عندي موعد عند الطبيب.",
      level: "A1",
    },
    {
      id: "fc2",
      de: "der Montag ... der Sonntag",
      ar: "أيام الأسبوع",
      example: "Heute ist Montag.",
      exampleAr: "اليوم الاثنين.",
      level: "A1",
    },
    {
      id: "fc3",
      de: "der Monat",
      ar: "الشهر",
      example: "Der Monat hat 30 Tage.",
      exampleAr: "الشهر فيه 30 يوماً.",
      level: "A1",
    },
    {
      id: "fc4",
      de: "die Jahreszeit",
      ar: "الفصل (من السنة)",
      example: "Meine Lieblingsjahreszeit ist der Frühling.",
      exampleAr: "فصلي المفضل الربيع.",
      level: "A1",
    },
    {
      id: "fc5",
    ...
    },
    {
      ...
      de: "am / im",
      ar: "على (يوم) / في (شهر)",
      example: "Am Montag, im Mai",
      exampleAr: "الاثنين، في مايو",
      level: "A1",
    },
    {
      id: "fc7",
      de: "der erste ... der letzte",
      ar: "الأول ... الأخير",
      example: "Der erste Monat ist Januar.",
      exampleAr: "الشهر الأول يناير.",
      level: "A1",
    },
    {
      id: "fc8",
      de: "die Ordinalzahl",
      ar: "العدد الترتيبي",
      example: "Der dritte Tag.",
      exampleAr: "اليوم الثالث.",
      level: "A1",
    },
    {
      id: "fc9",
      ...
      ar: "ما تاريخ اليوم؟",
      example: "Der wievielte ist heute? — Der dritte Mai.",
      exampleAr: "ما تاريخ اليوم؟ — الثالث من مايو.",
      level: "A1",
    },
    {
      id: "fc10",
      de: "am dritten Mai",
      ar: "في الثالث من مايو",
      example: "Ich habe am dritten Mai einen Termin.",
      exampleAr: "لديّ موعد في الثالث من مايو.",
      level: "A1",
    },
    {
      id: "fc11",
      de: "ab (+ Dativ)",
      ar: "ابتداءً من",
      example: "Ab Montag habe ich Zeit.",
      exampleAr: "ابتداءً من الاثنين أصير متفرّغاً.",
      level: "A1",
    },
    {
      id: "fc12",
      de: "von … bis …",
      ar: "من … إلى …",
      example: "Die Praxis ist von acht bis achtzehn Uhr offen.",
      exampleAr: "العيادة مفتوحة من الثامنة إلى السادسة مساءً.",
      level: "A1",
    },
    {
      id: "fc13",
      de: "gegen (+ Uhrzeit)",
      ar: "نحو، تقريباً",
      example: "Ich komme gegen drei Uhr.",
      exampleAr: "سآتي نحو الثالثة.",
      level: "A1",
    },
    {
      id: "fc14",
      de: "Ich hätte gern einen Termin.",
      ar: "أودّ موعداً.",
      example: "Guten Tag, ich hätte gern einen Termin.",
      exampleAr: "نهارك سعيد، أودّ موعداً.",
      level: "A1",
    },
    {
      id: "fc15",
      de: "Es tut mir leid, da kann ich nicht.",
      ar: "آسف، لا أستطيع في ذلك الوقت.",
      example: "Am Montag? Es tut mir leid, da kann ich nicht.",
      exampleAr: "الاثنين؟ آسف، لا أستطيع حينها.",
      level: "A1",
    },
    {
      id: "fc16",
      ...
      exampleAr: "هل يمكننا تأجيل الموعد؟",
      level: "A1",
    },
    {
      id: "fc17",
      ...
      exampleAr: "للأسف عليّ إلغاء الموعد.",
      level: "A1",
    },
    {
      id: "fc18",
      de: "montags, dienstags …",
      ar: "كلّ اثنين، كلّ ثلاثاء …",
      example: "Montags habe ich immer Deutschkurs.",
      exampleAr: "كلّ اثنين عندي درس ألمانية.",
      level: "A1",
    },
    {
      id: "fc19",
      de: "die Versichertenkarte",
      ar: "بطاقة التأمين الصحّيّ",
      example: "Bringen Sie bitte Ihre Versichertenkarte mit.",
      exampleAr: "أحضر بطاقة التأمين من فضلك.",
      level: "A1",
    },
    {
      id: "fc20",
      de: "die Praxis",
      ar: "العيادة",
      example: "Die Praxis ist am Dienstag geschlossen.",
      exampleAr: "العيادة مغلقة يوم الثلاثاء.",
      level: "A1",
    },
    {
      id: "fc21",
      ...
      exampleAr: "عندي موعد عند طبيب الأسنان.",
      level: "A1",
    },
    {
      id: "fc22",
      de: "passen",
      ar: "يناسب (موعداً)",
      example: "Passt Ihnen Dienstag um zehn?",
      exampleAr: "أيناسبك الثلاثاء في العاشرة؟",
      level: "A1",
    },
    {
      id: "fc23",
      de: "das Problem",
      ar: "المشكلة",
      example: "Kein Problem, bis morgen!",
      exampleAr: "لا مشكلة، إلى الغد!",
      level: "A1",
    },
    {
      id: "fc24",
      de: "klein",
      ar: "صغير",
      example: "Einen kleinen Moment, bitte.",
      exampleAr: "لحظةً صغيرة من فضلك.",
      level: "A1",
    },
  ],
  ...
  mediation: [
    {
      ...
      sourceDe:
        "Der Deutschkurs beginnt am Montag um 9 Uhr. Er dauert bis Freitag, jeden Tag zwei Stunden.",
      taskAr: "أخبر صديقاً بالعربية بموعد بدء الدورة ومدتها اليومية.",
      modelAnswerAr:
        "«تبدأ دورة الألمانية الاثنين الساعة 9. تستمر حتى الجمعة، ساعتان كل يوم.»",
      keyPointsAr: [
        "نقلت يوم ووقت البداية (الاثنين 9)",
        "نقلت مدة الدورة (حتى الجمعة)",
        "ذكرت الساعتين اليوميتين",
      ],
    },
  ],
  interaction: [
      ...
      rounds: [
        {
          ...
          options: [
            {
              de: "Ich möchte einen Termin beim Arzt machen.",
              ar: "أريد حجز موعد عند الطبيب.",
              best: true,
              replyDe: "Gerne. Wann passt es Ihnen?",
              replyAr: "بكل سرور. متى يناسبك؟",
            },
            {
              de: "Ich möchte einen Kaffee bestellen.",
              ar: "أريد طلب قهوة.",
              best: false,
              replyDe: "Das ist eine Arztpraxis, kein Café.",
              replyAr: "هذه عيادة طبية، وليست مقهى.",
            },
          ],
        },
        {
          speakerDe:
            "Wann passt es Ihnen? Wir haben am Mittwoch um 10 Uhr frei.",
          speakerAr: "متى يناسبك؟ لدينا الأربعاء الساعة 10.",
          options: [
            {
              de: "Am Mittwoch um 10 Uhr passt mir gut.",
              ar: "الأربعاء الساعة 10 يناسبني جيداً.",
              best: true,
              replyDe: "Perfekt, der Termin ist reserviert.",
              replyAr: "ممتاز، تم حجز الموعد.",
            },
            {
              de: "Ich komme am Donnerstag ohne Termin.",
              ar: "سآتي الخميس بدون موعد.",
              best: false,
              replyDe: "Ohne Termin geht es leider nicht.",
              replyAr: "بدون موعد لا يمكن للأسف.",
            },
          ],
        },
      ],
