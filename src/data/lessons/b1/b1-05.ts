...
export const lessonB105: Lesson = {
  ...
  writing: [
    ...
    },
    {
      ...
      blanks: [
        { correct: "wäre", options: ["wäre", "hätte", "würde"] },
  ...
  practiceBank: [
    ...
    },
    {
      ...
      options: ["hätte ... gelesen", "wäre ... gelesen", "hätte ... lesen", "würde ... gelesen"],
      correctIndex: 0,
  ...
  miniTest: [
    ...
    },
    {
      ...
      explanation: "gehen فعل حركة ⇒ Konjunktiv II بـ wäre: Ich wäre gestern gegangen.",
      errorType: "grammar",
    },
    {
      id: "m5",
