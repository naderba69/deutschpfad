...
export const lessonB108: Lesson = {
  ...
  writing: [
    ...
    },
    {
      ...
      blanks: [
        { correct: "nicht nur", options: ["nicht nur", "weder", "entweder"] },
        { correct: "sondern auch", options: ["sondern auch", "noch", "oder"] },
        { correct: "weder", options: ["weder", "nicht nur", "entweder"] },
        { correct: "noch", options: ["noch", "sondern auch", "oder"] },
      ],
  ...
  practiceBank: [
    ...
    },
    {
      ...
      explanation: "Futur I: werden مصرَّف حسب الفاعل + مصدر في النهاية. ich → werde.",
      errorType: "grammar",
    },
    {
      id: "e6",
      ...
      blanks: [
        { correct: "Entweder", options: ["Entweder", "Weder", "Sowohl"] },
        { correct: "oder", options: ["oder", "noch", "als auch"] },
        { correct: "sowohl", options: ["sowohl", "weder", "entweder"] },
        { correct: "als auch", options: ["als auch", "noch", "oder"] },
      ],
  ...
  miniTest: [
    {
      ...
      options: ["werden ... gestalten", "wird ... gestalten", "werdet ... gestalten", "werden ... gestaltet"],
      correctIndex: 0,
    ...
    },
    {
      ...
      blanks: [
        { correct: "sowohl", options: ["sowohl", "weder", "entweder"] },
        { correct: "als auch", options: ["als auch", "noch", "oder"] },
        { correct: "weder", options: ["weder", "sowohl", "entweder"] },
        { correct: "noch", options: ["noch", "als auch", "oder"] },
      ],
