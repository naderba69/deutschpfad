...
export const lessonB110: Lesson = {
  ...
  practiceBank: [
    ...
    },
    {
      ...
      wrongSentence: "Der Student, den Deutsch lernt, möchte studieren.",
      wrongWord: "den",
      correctWord: "der",
      options: ["der", "den", "dem", "dessen"],
      explanation: "الضمير النسبي فاعلُ جملته (wer lernt?) ⇒ Nominativ: der.",
      errorType: "grammar",
    },
    {
      id: "e6",
    ...
    },
    {
      ...
      type: "error-correction",
      instructionAr: "افحص الجملة: إن وجدت خطأً فاختر تصحيحه، وإلا فاختر «لا خطأ».",
      wrongSentence: "Je mehr ich lerne, desto besser verstehe ich.",
      wrongWord: "verstehe ich",
      correctWord: "verstehe ich",
      isAlreadyCorrect: true,
      options: ["verstehe ich", "ich verstehe", "verstehen ich", "ich verstehen"],
  ...
  miniTest: [
    ...
    },
    {
      ...
      type: "error-correction",
      instructionAr: "افحص الجملة: إن وجدت خطأً فاختر تصحيحه، وإلا فاختر «لا خطأ».",
      wrongSentence: "Der Mann, dem dort steht, ist mein Lehrer.",
      wrongWord: "dem",
      correctWord: "der",
      options: ["der", "dem", "den", "dessen"],
      explanation: "الضمير النسبي فاعلُ جملته (wer steht?) ⇒ Nominativ: der.",
      errorType: "grammar",
    },
    {
      id: "m5",
