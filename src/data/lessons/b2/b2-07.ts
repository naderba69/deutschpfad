...
export const lessonB207: Lesson = {
  ...
  practiceBank: [
    ...
    },
    {
      ...
      type: "error-correction",
      instructionAr: "افحص الجملة: إن وجدت خطأً فاختر تصحيحه، وإلا فاختر «لا خطأ».",
      wrongSentence: "Ich werde das Buch beendet sein.",
      wrongWord: "sein",
      correctWord: "haben",
      options: ["haben", "sein", "werden", "gehabt"],
      explanation: "beenden فعل متعدٍّ ⇒ مساعده haben: Ich werde das Buch beendet haben.",
      errorType: "grammar",
    },
    {
      id: "e10",
