...
export const lessonA201: Lesson = {
  ...
  lernziele: [
    { id: "z1", de: "Ich kann die Stammformen starker Verben in Reihen lernen.", ar: "أن أتعلّم صور الأفعال القوية الثلاث في عائلاتٍ لا قوائم." },
    { id: "z2", de: "Ich weiß, wann man Perfekt und wann Präteritum benutzt.", ar: "أن أعرف متى أستعمل Perfekt ومتى Präteritum (war · hatte · konnte)." },
    { id: "z3", de: "Ich kann längere Sätze im Perfekt richtig ordnen.", ar: "أن أرتّب المساحة الوسطى في جملة Perfekt الطويلة ترتيباً صحيحاً." },
    { id: "z4", de: "Ich kann eine Reise buchen und mich höflich beschweren.", ar: "أن أحجز رحلةً وأشتكي بأدبٍ في فندقٍ أو محطّة." },
    { id: "z5", de: "Ich kann eine Reisegeschichte zusammenhängend erzählen.", ar: "أن أحكي قصّة رحلةٍ حكايةً مترابطة." },
  ],
  einfuehrung: {
  ...
  theory: [
    {
      ...
      table: {
        ...
        rows: [
          { label: "i – a – u", cells: ["trinken", "trank", "getrunken", "يشرب"] },
          { label: "i – a – u", cells: ["finden", "fand", "gefunden", "يجد"] },
          { label: "ei – ie – ie", cells: ["schreiben", "schrieb", "geschrieben", "يكتب"] },
          { label: "ei – ie – ie", cells: ["bleiben", "blieb", "geblieben", "يبقى (مع sein)"] },
          { label: "ie – o – o", cells: ["fliegen", "flog", "geflogen", "يطير (مع sein)"] },
          { label: "e – a – o", cells: ["nehmen", "nahm", "genommen", "يأخذ"] },
          { label: "e – a – o", cells: ["sprechen", "sprach", "gesprochen", "يتكلّم"] },
          { label: "مختلط", cells: ["denken", "dachte", "gedacht", "يفكّر"] },
          { label: "مختلط", cells: ["bringen", "brachte", "gebracht", "يُحضر"] },
        ],
      },
      examples: [
        { de: "Wir haben den ganzen Abend gesungen.", ar: "غنّينا طوال المساء. (singen – sang – gesungen، نمط i–a–u)" },
        { de: "Ich habe meinen Schlüssel nicht gefunden.", ar: "لم أجد مفتاحي. (finden، النمط نفسه)" },
        { de: "Sie ist nach Istanbul geflogen.", ar: "طارت إلى إسطنبول. (fliegen، نمط ie–o–o + sein للحركة)" },
        { de: "Ich habe meinen Pass verloren.", ar: "أضعتُ جواز سفري. (verlieren – verlor – verloren)" },
        { de: "Hast du mit dem Chef gesprochen?", ar: "هل تكلّمتَ مع المدير؟ (sprechen، نمط e–a–o)" },
        { de: "Er hat mir sehr geholfen.", ar: "ساعدني كثيراً. (helfen، النمط نفسه، ومفعوله بالجرّ)" },
        { de: "Daran habe ich gar nicht gedacht.", ar: "لم أفكّر في ذلك إطلاقاً. (denken — مختلط: تغيّرُ جذرٍ ونهاية -t)" },
        { de: "Ich habe dir ein Geschenk mitgebracht.", ar: "أحضرتُ لك هديّة. (bringen مختلط + بادئة منفصلة)" },
      ],
    ...
    },
    {
      ...
      table: {
        ...
        rows: [
          { label: "حديثٌ عن العطلة", cells: ["Perfekt", "Ich bin nach Wien gefahren."] },
          { label: "رسالةٌ إلى صديق", cells: ["Perfekt", "Wir haben viel gelacht."] },
          { label: "رواية أو خبر صحفيّ", cells: ["Präteritum", "Der Zug erreichte den Bahnhof um acht."] },
          { label: "sein في الكلام", cells: ["Präteritum", "Ich war sehr müde."] },
          { label: "haben في الكلام", cells: ["Präteritum", "Wir hatten keine Zeit."] },
          { label: "فعلٌ ناقص في الكلام", cells: ["Präteritum", "Ich konnte nicht schlafen."] },
          { label: "es gibt في الكلام", cells: ["Präteritum", "Es gab keinen Kaffee mehr."] },
        ],
      },
      examples: [
        { de: "Ich war letztes Jahr in Ägypten. Es war fantastisch!", ar: "كنتُ العام الماضي في مصر. كان رائعاً! (sein ⟵ Präteritum حتّى في الكلام)" },
        { de: "Wir hatten leider kein Glück mit dem Wetter.", ar: "للأسف لم يحالفنا الحظّ في الطقس. (haben ⟵ hatten)" },
        { de: "Ich konnte gestern nicht kommen, ich musste arbeiten.", ar: "لم أستطع المجيء أمس، كان عليّ أن أعمل. (ناقصان بالـPräteritum)" },
        { de: "Ich bin nach Wien gefahren und habe dort meine Tante besucht.", ar: "سافرتُ إلى فيينّا وزرتُ عمّتي هناك. (الأفعال العادية ⟵ Perfekt)" },
        { de: "Es gab im Hotel kein WLAN.", ar: "لم يكن في الفندق واي فاي. (es gibt ⟵ es gab)" },
        { de: "Der Zug fuhr um acht Uhr ab und erreichte Berlin am Mittag.", ar: "انطلق القطار في الثامنة وبلغ برلين ظهراً. (سردٌ مكتوب ⟵ Präteritum)" },
        { de: "Ich wusste nicht, dass du auch hier bist.", ar: "لم أكن أعرف أنّك هنا أيضاً. (wissen ⟵ wusste)" },
        { de: "Wie war dein Urlaub? – Er war super, aber zu kurz!", ar: "كيف كانت عطلتك؟ — كانت رائعة لكنّها قصيرة جداً!" },
      ],
      comparisonWithArabic:
    ...
    },
    {
      ...
      table: {
        ...
        rows: [
          { label: "١", cells: ["الضمائر (منصوب قبل مجرور)", "Ich habe es ihm gegeben."] },
          ...
          { label: "٧", cells: ["nicht لنفي الجملة", "… das Buch nicht gelesen."] },
        ],
      },
      examples: [
        { de: "Ich habe dir gestern eine Nachricht geschickt.", ar: "أرسلتُ لك رسالةً أمس. (ضميرٌ ثمّ زمانٌ ثمّ مفعول)" },
        { de: "Wir sind letzten Sommer mit dem Zug nach Prag gefahren.", ar: "سافرنا الصيف الماضي بالقطار إلى براغ. (زمان ⟵ كيفية ⟵ مكان)" },
        { de: "Ich habe es ihm schon gesagt.", ar: "قلتُه له بالفعل. (ضميران: المنصوب es قبل المجرور ihm)" },
        { de: "Ich habe meinem Bruder das Buch gegeben.", ar: "أعطيتُ أخي الكتاب. (اسمان: المجرور قبل المنصوب — عكس الضمائر)" },
        { de: "Ich habe den Film nicht gesehen.", ar: "لم أشاهد الفيلم. (nicht قبل Partizip II لنفي الجملة كلّها)" },
        { de: "Ich habe nicht den Film gesehen, sondern die Serie.", ar: "لم أشاهد الفيلمَ بل المسلسل. (nicht قبل الجزء المنفيّ وحده)" },
        { de: "Er hat mir gestern wegen der Prüfung lange geholfen.", ar: "ساعدني أمس طويلاً بسبب الامتحان. (ضمير ⟵ زمان ⟵ سبب ⟵ كيفية)" },
        { de: "Ich habe gehört, dass du umgezogen bist.", ar: "سمعتُ أنّك انتقلتَ. (الجملة الفرعية تخرج بعد القوس)" },
      ],
      comparisonWithArabic:
    ...
    },
    {
      ...
      table: {
        ...
        rows: [
          { label: "buchen / reservieren", cells: ["يحجز", "Ich habe gebucht (haben — له مفعول)"] },
          { label: "abfahren", cells: ["ينطلق (قطار/حافلة)", "ist abgefahren — حركة + منفصل"] },
          { label: "ankommen", cells: ["يصل", "ist angekommen"] },
          { label: "umsteigen", cells: ["يبدّل وسيلة النقل", "ist umgestiegen"] },
          { label: "landen", cells: ["يهبط (طائرة)", "ist gelandet"] },
          { label: "hin und zurück", cells: ["ذهاباً وإياباً", "مقابل einfach = ذهاباً فقط"] },
          { label: "die Verspätung", cells: ["التأخير", "Der Zug hat Verspätung."] },
          { label: "leider", cells: ["للأسف", "كلمة تلطيف الشكوى"] },
        ],
      },
      examples: [
        { de: "Ich habe online ein Doppelzimmer für zwei Nächte gebucht.", ar: "حجزتُ عبر الإنترنت غرفةً مزدوجة لليلتين." },
        { de: "Einmal nach Hamburg, bitte. – Einfach oder hin und zurück?", ar: "تذكرة إلى هامبورغ من فضلك. — ذهاباً فقط أم ذهاباً وإياباً؟" },
        { de: "Der Zug ist mit zwanzig Minuten Verspätung angekommen.", ar: "وصل القطار متأخّراً عشرين دقيقة." },
        { de: "In Frankfurt müssen Sie umsteigen.", ar: "في فرانكفورت عليك تبديل القطار." },
        { de: "Wir sind um Mitternacht in Wien gelandet.", ar: "هبطنا في فيينّا منتصف الليل." },
        { de: "Entschuldigung, das Zimmer ist leider nicht sauber.", ar: "عذراً، الغرفة للأسف ليست نظيفة. (خطوة المشكلة)" },
        { de: "Könnten Sie mir bitte ein anderes Zimmer geben?", ar: "هل يمكنكم إعطائي غرفةً أخرى من فضلكم؟ (خطوة الطلب)" },
  ...
  reading: {
    ...
    "questions": [
      {
        ...
        "correctIndex": 0,
        "explanation": "«Wir buchten die Zugtickets schon im Mai, reservierten ein kleines Hotel» — حجزٌ مسبق في مايو.",
      ...
      },
      {
        ...
        "correctIndex": 0,
        "explanation": "الإعلان قال: «Der Zug nach Prag hat heute zwei Stunden Verspätung».",
        "errorType": "vocabulary"
      },
      {
        "id": "rq3",
        ...
        "correctIndex": 0,
        "explanation": "«Meine Schwester hat ihren Rucksack im ersten Zug vergessen — mit ihrem Pass und ihrem Geld.»",
        "errorType": "vocabulary"
      },
      {
        "id": "rq4",
        ...
        "correctIndex": 0,
        "explanation": "Präteritum هو زمن السرد المكتوب. ولو حكى الراوي القصّة شفهياً لقال «wir haben gebucht».",
        "errorType": "grammar"
      },
      {
        "id": "rq5",
        ...
        "correctIndex": 0,
        "explanation": "«sind wir endlich abgefahren» — الحركة بين نقطتين تستدعي sein. والانفصال يُحدّد موضع ge- لا المساعد.",
        "errorType": "grammar"
      },
      {
        "id": "rq6",
        ...
        "correctIndex": 0,
        "explanation": "«ein anderes Hotel gefunden … und es war sogar billiger und schöner».",
        "errorType": "vocabulary"
      }
    ],
    "redemittel": [
    ...
    "discussionAr": "احكِ رحلةً لك سارت على غير ما خُطّط لها، في ثماني جملٍ على الأقلّ. استعمل Perfekt للأفعال العادية وPräteritum لـwar وhatte وkonnte وmusste، وأدخل ثلاثة على الأقلّ من أفعال السفر المنفصلة (abfahren · ankommen · umsteigen · abholen). ثمّ راجع كلّ جملة: هل أغلقتَ القوس بـPartizip II في آخرها؟"
  },
  ...
  practiceBank: [
    ...
    },
    {
      ...
      explanation: "fliegen فعل حركة ⇒ مساعده sein: Ich bin nach Berlin geflogen.",
      errorType: "grammar",
    },
    {
      id: "e6",
    ...
    },
    {
      ...
      correctWord: "bin",
      options: ["bin", "habe", "war", "hatte"],
      explanation: "schwimmen حركة → sein: Ich bin geschwommen. والتصريف الثالث القوي geschwommen.",
      errorType: "grammar",
    },
    {
      id: "e10",
    ...
    },
    {
      ...
      blanks: [{ correct: "gesungen", options: ["gesungen", "gesingt", "gesangen", "gesungt"], errorType: "grammar" }],
    ...
    },
    {
      ...
      blanks: [{ correct: "geschrieben", options: ["geschrieben", "geschreibt", "geschreiben", "schrieb"], errorType: "grammar" }],
      explanation: "schreiben – schrieb – geschrieben: تتغيّر الحركة وتبقى النهاية -en.",
      errorType: "grammar",
    },
    {
      id: "e13",
      ...
      explanation: "أربع عائلاتٍ كبرى وطائفةٌ مختلطة — من عرف النمط استغنى عن حفظ القائمة كلّها.",
      errorType: "grammar",
    },
    {
      id: "e14",
      ...
      correctIndex: 0,
      explanation: "sein تُقال بالـPräteritum في الكلام. والثانية صحيحةٌ نحواً لكنّها ثقيلة ونادرة.",
      errorType: "grammar",
    },
    {
      id: "e15",
      ...
      template: "Ich ___ nicht kommen, ich ___ arbeiten. Es ___ keine andere Möglichkeit.",
      blanks: [
        { correct: "konnte", options: ["konnte", "habe gekonnt", "kann", "könnte"], errorType: "grammar" },
        { correct: "musste", options: ["musste", "habe gemusst", "muss", "müsste"], errorType: "grammar" },
        { correct: "gab", options: ["gab", "hat gegeben", "gibt", "gegeben"], errorType: "grammar" },
      ],
      explanation: "الأفعال الناقصة وes gibt تُقال بالـPräteritum في الكلام: konnte · musste · gab.",
      errorType: "grammar",
    },
    {
      id: "e16",
      ...
      tokens: ["Wir", "sind", "letzten", "Sommer", "mit", "dem", "Zug", "nach", "Prag", "gefahren"],
      correctSentence: "Wir sind letzten Sommer mit dem Zug nach Prag gefahren",
      explanation: "زمان (letzten Sommer) ⟵ كيفية (mit dem Zug) ⟵ مكان (nach Prag)، وPartizip II يُغلق.",
      errorType: "word-order",
    },
    {
      id: "e17",
      ...
      explanation: "بين الضميرين يتقدّم المنصوب (es) على المجرور (ihm) — عكس ترتيب الأسماء.",
      errorType: "word-order",
    },
    {
      id: "e18",
      ...
      options: ["einen Apfel gegessen", "gegessen einen Apfel", "einen Apfel essen", "gegessen ein Apfel"],
      explanation: "Partizip II يُغلق الجملة، فالمفعول يسبقه — وهذا أشيع أخطاء العرب في الجملة الطويلة.",
      errorType: "word-order",
    },
    {
      id: "e19",
      ...
      correctIndex: 0,
      explanation: "nicht قبل جزءٍ بعينه ينفيه وحده. ولنفي الجملة كلّها يوضع قبل Partizip II: «Ich habe den Film nicht gesehen».",
      errorType: "negation",
    },
    {
      id: "e20",
      ...
      template: "Der Zug ___ pünktlich abgefahren, und wir ___ um acht angekommen.",
      blanks: [
        { correct: "ist", options: ["ist", "hat", "war", "wird"], errorType: "grammar" },
        { correct: "sind", options: ["sind", "haben", "waren", "werden"], errorType: "grammar" },
      ],
      explanation: "abfahren وankommen حركةٌ بين نقطتين ⟵ sein. وأفعال السفر كلّها على هذا النمط.",
      errorType: "grammar",
    },
    {
      id: "e21",
      ...
      correctIndex: 0,
      explanation: "einfach في سياق التذاكر تعني «ذهاباً فقط» لا «بسيط» — فخّ معجميّ يشتري به المتعلّم تذكرةً بلا عودة.",
      errorType: "vocabulary",
    },
    {
      id: "e22",
      ...
      correctIndex: 0,
      explanation: "الشكوى الألمانية مباشرةٌ ومغلَّفة: Entschuldigung + leider + المشكلة صريحةً + Könnten Sie …?",
      errorType: "vocabulary",
    },
    {
      id: "e23",
      ...
      prompt: "Der Zug fuhr um acht ab und erreichte Berlin am Mittag. → (im Gespräch)",
      acceptedAnswers: [
        "Der Zug ist um acht abgefahren und hat Berlin am Mittag erreicht.",
        "Der Zug ist um acht abgefahren und hat Berlin am Mittag erreicht",
      ],
      sampleAnswer: "Der Zug ist um acht abgefahren und hat Berlin am Mittag erreicht.",
      hint: "الأفعال العادية في الكلام تُقال بالـPerfekt، وabfahren حركة ⟵ sein.",
      explanation: "abfahren ⟵ ist abgefahren (حركة) · erreichen له مفعول ⟵ hat erreicht.",
      errorType: "grammar",
    },
    {
      id: "e24",
      ...
      textDe: "Wir hatten alles geplant. Aber der Zug hatte drei Stunden Verspätung. In Dresden mussten wir umsteigen. Am Ende sind wir um Mitternacht angekommen. Das Hotel war trotzdem noch offen, und wir konnten sofort einchecken.",
      statements: [
        { id: "s1", de: "Der Zug war pünktlich.", ar: "كان القطار في موعده.", isTrue: false, whyAr: "النصّ يقول «drei Stunden Verspätung» — تأخّر ثلاث ساعات." },
        { id: "s2", de: "Sie mussten in Dresden umsteigen.", ar: "كان عليهم تبديل القطار في درسدن.", isTrue: true, whyAr: "«In Dresden mussten wir umsteigen»." },
        { id: "s3", de: "Im Text stehen hatten, mussten und konnten im Präteritum.", ar: "الأفعال hatten وmussten وkonnten وردت بالـPräteritum.", isTrue: true, whyAr: "haben والأفعال الناقصة تُقال بالـPräteritum حتّى في الكلام." },
        { id: "s4", de: "Das Hotel war schon geschlossen.", ar: "كان الفندق قد أُغلق.", isTrue: false, whyAr: "«Das Hotel war trotzdem noch offen»." },
      ],
      explanation: "النصّ يجمع القاعدتين: Perfekt للأفعال العادية (sind angekommen) وPräteritum لـhaben والناقصة.",
      errorType: "grammar",
    },
  ],
  ...
  miniTest: [
    ...
    },
    {
      ...
      explanation: "fahren فعل حركة ⇒ مساعده sein: Wir sind nach Tunis gefahren.",
      errorType: "grammar",
    },
    {
      id: "m5",
  ...
  flashcards: [
    ...
    { id: "fc9", de: "buchen (hat gebucht)", ar: "يحجز", example: "Ich habe ein Zimmer gebucht.", exampleAr: "حجزتُ غرفة.", level: "A2" },
    { id: "fc10", de: "abfahren (ist abgefahren)", ar: "ينطلق (قطار أو حافلة)", example: "Der Zug ist pünktlich abgefahren.", exampleAr: "انطلق القطار في موعده.", level: "A2" },
    { id: "fc11", de: "ankommen (ist angekommen)", ar: "يصل", example: "Wir sind um acht angekommen.", exampleAr: "وصلنا في الثامنة.", level: "A2" },
    { id: "fc12", de: "umsteigen (ist umgestiegen)", ar: "يبدّل وسيلة النقل", example: "In Dresden mussten wir umsteigen.", exampleAr: "في درسدن كان علينا التبديل.", level: "A2" },
    { id: "fc13", de: "die Verspätung", ar: "التأخير", example: "Der Zug hat zwei Stunden Verspätung.", exampleAr: "القطار متأخّر ساعتين.", level: "A2" },
    { id: "fc14", de: "hin und zurück", ar: "ذهاباً وإياباً (مقابل einfach)", example: "Einmal nach Hamburg, hin und zurück.", exampleAr: "تذكرة إلى هامبورغ ذهاباً وإياباً.", level: "A2" },
    { id: "fc15", de: "abholen (hat abgeholt)", ar: "يستلم، يأخذ", example: "Wir haben den Rucksack abgeholt.", exampleAr: "استلمنا حقيبة الظهر.", level: "A2" },
    { id: "fc16", de: "vergessen (hat vergessen)", ar: "ينسى", example: "Sie hat ihren Rucksack im Zug vergessen.", exampleAr: "نسيت حقيبتها في القطار.", level: "A2" },
    { id: "fc17", de: "die Überraschung", ar: "المفاجأة", example: "Das war eine schöne Überraschung.", exampleAr: "كانت مفاجأةً جميلة.", level: "A2" },
    { id: "fc18", de: "leider", ar: "للأسف (كلمة تلطيف الشكوى)", example: "Das Zimmer ist leider nicht sauber.", exampleAr: "الغرفة للأسف ليست نظيفة.", level: "A2" },
    { id: "fc19", de: "die Rezeption", ar: "مكتب الاستقبال", example: "Die Frau an der Rezeption hat uns geholfen.", exampleAr: "ساعدتنا الموظّفة في الاستقبال.", level: "A2" },
    { id: "fc20", de: "die Durchsage", ar: "إعلانٌ صوتيّ (في محطّة أو مطار)", example: "Am Bahnhof gab es eine Durchsage.", exampleAr: "كان في المحطّة إعلان.", level: "A2" },
  ],
