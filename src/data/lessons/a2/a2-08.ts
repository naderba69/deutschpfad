...
export const lessonA208: Lesson = {
  ...
  practiceBank: [
    ...
    },
    {
      ...
      tokens: ["schneller", "Der", "Zug", "als", "Bus", "ist", "der", "."],
    ...
    },
    {
      ...
      wrongWord: "ab um zehn Uhr",
      correctWord: "um zehn Uhr ab",
      options: ["um zehn Uhr ab", "ab um zehn Uhr", "um ab zehn Uhr", "um zehn ab Uhr"],
  ...
  miniTest: [
    ...
    },
    {
      ...
      type: "word-ordering",
      instructionAr: "رتّب الجملة:",
      tokens: ["als", "Das", "Taxi", "ist", "Auto", "das", "teurer", "."],
