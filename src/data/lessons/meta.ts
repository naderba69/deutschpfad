...
/**
 * ═══════════════════════════════════════════════════════════
 *  فهرس الدروس الخفيف (بيانات وصفية فقط)
 *  يُحرَّر يدوياً: كل درس جديد يحتاج مدخلاً هنا بجانب تسجيله في index.ts.
 *  (لا مولِّد آلياً — الإشارة السابقة إلى scripts/gen-lesson-meta.py كانت
 *   لسكربت غير موجود. العدد الفعلي مشتقّ في TOTAL_LESSONS ومحروس
 *   باختبارات consistency.test.ts، فلا يُكتب رقمٌ ثابت هنا.)
 ...
 * إلى درس الماضي المحكيّ (وهو الدرس الثاني للوحدة a1-07) ثم يعود للمراجعة الشاملة.
 */
...
const LESSON_META_SOURCE: LessonMeta[] = [
  ...
  { id: "a1-14", unitId: "a1-07", level: "A1", order: 2, titleDe: "Das Perfekt: Was hast du gemacht?", titleAr: "الماضي المحكيّ (Perfekt) — ماذا فعلتَ؟", duration: 40, summary: "الزمن الماضي المستعمل في الكلام: haben أو sein + Partizip II، وصناعة Partizip II في الأفعال الضعيفة والقوية والمنفصلة وغير المنفصلة وأفعال -ieren، وقاعدة اختيار المساعد باختبار المفعول به، ثمّ الفعلان الناقصان الأخيران wollen وsollen.", keyWords: ["das Perfekt", "gemacht (machen)", "gefahren (fahren)", "wollen", "sollen"] },
  { id: "a1-13", unitId: "a1-13", level: "A1", order: 1, titleDe: "A1 kompakt — die große Wiederholung", titleAr: "A1 المراجعة الشاملة", duration: 35, summary: "المراجعة الختامية لمستوى A1: ردّ قواعد المستوى الاثنتي عشرة إلى ثلاثة قوانين (الفعل في المركز الثاني، الحاضنة الفعلية، النهايات تحمل المعنى)، ودمجها في مشهدين كاملين، ثم بنية امتحان Start Deutsch 1 واستراتيجياته.", keyWords: ["die Wiederholung", "der Satz", "kombinieren", "die Prüfung", "die Brücke"] },
  ...
  { id: "a2-13", unitId: "a2-13", level: "A2", order: 1, titleDe: "A2 kompakt — die Brücke nach B1", titleAr: "A2 الشاملة — الجسر إلى B1", duration: 35, summary: "المراجعة الختامية لمستوى A2: الماضي التام، الأفعال الناقصة، حروف الجر المتغيّرة، war/hatte، الجمل الثانوية (dass, weil, wenn, ob)، حالة الجر Dativ، المقارنة، والأفعال الانعكاسية — مدموجةً في مواقف حية، مع اختبار تجميعي وخريطة صريحة لما يتغيّر في B1.", keyWords: ["die Brücke", "zusammenfassen", "bestehen", "der Fortschritt", "die Stufe"] },
  ...
  { id: "b1-12", unitId: "b1-10", level: "B1", order: 2, titleDe: "Ziele, Gründe und Absichten", titleAr: "الأهداف والأسباب والنوايا", duration: 40, summary: "التعبير عن الغرض بـ damit و um … zu (وشرط وحدة الفاعل)، وحروف الجر مع المضاف إليه (wegen, trotz, während, aufgrund) وبدائلها الشائعة في اللغة المحكية.", keyWords: ["um … zu", "damit", "wegen", "trotz"] },
  ...
  { id: "b2-11", unitId: "b2-04", level: "B2", order: 2, titleDe: "Zugehörigkeit und doppelter Infinitiv", titleAr: "الإسناد والمِلكية في الجملة المركّبة", duration: 45, summary: "الضمائر النسبية في حالة المضاف إليه (dessen/deren)، والصيغة المصدرية المزدوجة في الماضي (habe arbeiten müssen) مع الأفعال المودالية وlassen وأفعال الإدراك.", keyWords: ["dessen", "deren", "der doppelte Infinitiv", "reparieren lassen"] },
