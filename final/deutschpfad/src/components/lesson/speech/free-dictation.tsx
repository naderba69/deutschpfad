    ...
    <div className="space-y-4">
      ...
      <form onSubmit={check} className="flex items-center gap-2">
        <input
          ...
          lang="de"
          aria-label="إجابتك"
          className="font-de h-11 w-full rounded-xl border border-input bg-background px-4 text-base outline-none placeholder:text-muted-foreground focus:border-primary focus:ring-2 focus:ring-ring"
        />
