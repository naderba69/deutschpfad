  ...
  if (phase === "intro") {
    return (
      <div className="rounded-2xl border bg-muted/20 p-8 text-center">
        ...
        {/* اختيار الصيغة */}
        <div className="mx-auto mt-6 grid max-w-lg gap-3 sm:grid-cols-2" role="radiogroup" aria-label="صيغة الامتحان">
          <button
            type="button"
            role="radio"
          ...
          >
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              عرض تقديمي لموضوع (3د) مع أسئلة إرشادية + مناقشة (4د) — كما في Goethe-Zertifikat B2.
            </p>
          </button>
          <button
            type="button"
