      ...
      <CardContent className="p-0">
        ...
        <div className="flex items-center gap-3 border-b px-6 py-4">
          ...
          <div className="shrink-0 rounded-xl bg-muted px-3 py-1.5 text-center">
            ...
            <p className="text-[10px] font-bold text-muted-foreground">درس مكتمل</p>
          </div>
        </div>
          ...
          {LEVELS.map((level) => {
            ...
            return (
              <div key={level.code} id={`path-${level.code.toLowerCase()}`} className="scroll-mt-24">
                {/* رأس المستوى */}
                <div className="flex items-center justify-between gap-3 bg-muted/30 px-6 py-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <LangDe className="text-sm font-bold">{level.titleDe}</LangDe>
                ...
                {/* الدروس */}
                <div className="grid gap-1.5 px-4 py-4 sm:grid-cols-2 sm:px-6">
                  {levelLessons.map((lesson) => {
                    ...
                    return (
                      <Link
                        ...
                        className={cn(
                          "group flex items-center gap-3 rounded-xl border bg-card px-3.5 py-3 transition-colors hover:border-primary/40 hover:bg-primary/[0.03]",
