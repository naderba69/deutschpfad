...
export const HOEREN_LIBRARY: HoerenText[] = [
  ...
  },
  {
    ...
    textAr: "نهارك سعيد سيد علي. هنا عيادة د. فيبر. موعدك غداً العاشرة يجب تأجيله للأسف. هل تستطيع القدوم الخميس الثانية عشرة؟ من فضلك اتصل بنا على الرقم 0 30 55 66 77. شكراً!",
    questions: [
      ...
      { q: "Wann kann Herr Ali kommen?", qAr: "متى يستطيع السيد علي القدوم؟", options: ["am Donnerstag um vierzehn Uhr", "am Freitag um zehn Uhr", "am Montag", "morgen"], correct: 0, explanation: "الخميس الثانية عشرة." },
    ],
  },
  {
    id: "h-a2-3",
