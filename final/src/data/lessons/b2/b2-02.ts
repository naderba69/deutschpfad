...
export const lessonB202: Lesson = {
  ...
  theory: [
    {
      ...
      comparisonWithArabic:
        "«تُفتح» مقابل «مفتوحة» مقابل «قابلة للفتح» — العربية تملك نفس التدرج! والألمانية: wird geöffnet / ist geöffnet / ist öffenbar. والتشابه مذهل: -bar ≈ «-able/-able» مثل «قابل للفتح».",
      eselsbruecke:
  ...
  flashcards: [
    ...
    { id: "fc7", de: "-bar", ar: "قابل للـ", example: "trinkbar, öffenbar", exampleAr: "قابل للشرب/الفتح", level: "B2" },
