...
export const lessonA100: Lesson = {
  ...
  theory: [
    {
      ...
      table: {
        ...
        rows: [
          ...
          { label: "G g", cells: ["غ (قريباً)", "der Garten (حديقة)"] },
          ...
          { label: "ß", cells: ["سّ (قوية طويلة)", "die Straße (شارع)"] },
        ],
      },
      examples: [
      ...
      comparisonWithArabic:
        "العربية لا تملك أصواتاً مثل ü وö وß، لكنها تملك خاءً قريبة من ch الحلقية، وغيناً قريبة من g الألمانية. القاعدة الذهبية: كل حرف ألماني له صوت واحد ثابت — بينما العربية تعتمد على الحركات القصيرة التي تُكتب أحياناً وتُحذف أحياناً.",
      eselsbruecke:
      ...
      relatedRuleComparison: {
        ...
        content:
          "هذا موضوع الدرس القادم في هذا الدرس نفسه: ei تُنطق «آي» وie تُنطق «إي». القاعدة المضحكة: «الحرف الأطول في الكتابة هو الأقصر في النطق»!",
      },
    },
    {
      id: "t2",
  ...
  writing: [
    ...
    },
    {
      ...
      explanation: "المرجع: mein (آي) / Wien (إي) / lieben (إي) / nein (آي). الحرف الأطول يُنطق أقصر!",
      errorType: "spelling",
    },
    {
      id: "w3",
  ...
  miniTest: [
    ...
    },
    {
      ...
      explanation: "nein=آي، diese=إي، wie=إي، kein=آي. الحرف الأطول = الصوت الأقصر.",
      errorType: "spelling",
    },
    {
      id: "m5",
