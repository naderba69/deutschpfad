 ...
 * ═══════════════════════════════════════════════════════════
 *  4 مستويات (A1→B2) × 45 وحدة دراسية على نمط فصول كتب غوته
 */
...
export const UNITS: Unit[] = [
  ...
  },
  {
    ...
    titleDe: "Einkaufen",
    titleAr: "التسوق",
    descDe: "Einkaufen, Preise und Mengenangaben.",
    descAr: "التسوق، الأسعار، كميات (eins/kilo/gramm)، والأرقام حتى 1000.",
    lessons: 6,
    minutes: 50,
    keyWords: ["der Preis", "kosten", "das Kilo", "der Euro"],
  },
  {
    id: "a1-08",
    level: "A1",
...
/** إجمالي عدد الدروس التقديري في المنهج */
export const TOTAL_LESSONS = UNITS.reduce((sum, u) => sum + u.lessons, 0);
