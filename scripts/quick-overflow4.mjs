...
const PAGES = ["/grammatik/funktionsverbgefuege","/wortschatz-b2/top500","/tests/fallstricke","/writing-path","/tests/b2","/grammatik","/wortschatz-b2","/tests"];
...
for (const path of PAGES) {
  ...
  try {
    ...
    const r = await page.evaluate(() => {
      ...
      const bad = [];
      document.querySelectorAll("main div, main a, main button, main span, main p, main h1, main h2, main td").forEach((el) => {
