      ...
      <CardContent className="space-y-4 p-5">
        <div className="grid grid-cols-3 gap-2 text-center">
          <div className="rounded-xl border bg-background p-3">
            ...
            <p className="text-[10px] text-muted-foreground">إجمالي الدراسة</p>
          </div>
          <div className="rounded-xl border bg-background p-3">
            ...
            <p className="text-[10px] text-muted-foreground">متوسط يومي (14 يوم)</p>
          </div>
          <div className="rounded-xl border bg-background p-3">
            ...
            <p className="text-[10px] text-muted-foreground">يوم نشاط</p>
          </div>
        </div>
