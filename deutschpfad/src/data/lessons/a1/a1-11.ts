...
export const lessonA111: Lesson = {
  ...
  fehlerUndTipps: {
    ...
    culturalNote: {
      ...
      content:
        "الألمان فخورون بمواصلاتهم: U-Bahn (مترو)، S-Bahn (قطار ضواحي)، Straßenbahn (ترام)، Bus. والبطاقة الشهيرة: «Deutschlandticket» بـ 49 يورو شهرياً تغطي كل وسائل النقل المحلية. ستتعلم شراء التذاكر بالتفصيل في A2.",
    },
  },
  miniTest: [
    {
