  ...
  theory: [
    {
      ...
      explanationAr:
        "Partizip I (فاعل/نشط): جذر + end: das spielende Kind (الطفل اللاعب). Partizip II (مفعول/منتهي): der geschriebene Brief (الرسالة المكتوبة). كلاهما يتصرف كصفة كاملة: ein spielendes Kind، die geschriebene Briefe. وتختصر الجمل النسبية: der Mann, der arbeitet → der arbeitende Mann.",
      whyAr:
