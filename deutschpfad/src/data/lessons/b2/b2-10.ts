...
export const lessonB210: Lesson = {
  ...
  fehlerUndTipps: {
    ...
    culturalNote: {
      ...
      content:
        "الدراسة في ألمانيا مجانية تقريباً (رسوم فصل ~300 يورو). والجامعات: TU (تقنية)، Universität (شاملة)، Fachhochschule (تطبيقية). وتحتاج B2 أو TestDaF للقبول. وعبارة: «Der Numerus clausus» (الحد الأقصى للمقاعد) لبعض التخصصات مثل الطب.",
    },
  },
